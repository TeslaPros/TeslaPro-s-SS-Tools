...
<Window
    ...
    <Window.Resources>
        ...
        <Style TargetType="ListBox">
            ...
            <Setter Property="BorderThickness" Value="0"/>
            <Setter Property="Foreground" Value="#D8E8F5"/>
            <Setter Property="FontSize" Value="13"/>
            ...
            <Setter Property="Template">
                <Setter.Value>
                    <ControlTemplate TargetType="ListBoxItem">
                        ...
                        <ControlTemplate.Triggers>
                            <Trigger Property="IsMouseOver" Value="True">
                                <Setter TargetName="ItemRoot" Property="BorderBrush" Value="#2D89A8"/>
                                <Setter TargetName="ItemRoot" Property="Opacity" Value="0.98"/>
                            </Trigger>
                            <Trigger Property="IsSelected" Value="True">
                                <Setter TargetName="ItemRoot" Property="BorderBrush" Value="#35D9FF"/>
                                <Setter TargetName="ItemRoot" Property="Background" Value="#112231"/>
                            </Trigger>
                        </ControlTemplate.Triggers>
                    </ControlTemplate>
                </Setter.Value>
                        ...
                        <Border Grid.Row="4" Style="{StaticResource CardBorderStyle}">
                            <Grid>
                                ...
                                <Grid>
                                    ...
                                    <StackPanel>
                                        <TextBlock Text="Tools Explorer" FontSize="22" FontWeight="SemiBold" Foreground="White"/>
                                ...
                                <Grid Grid.Row="4">
                                    ...
                                    <Border Grid.Column="1"
                                        ...
                                        <Grid>
                                            ...
                                            <StackPanel>
                                                <TextBlock Text="Selected Tool" FontSize="16" FontWeight="SemiBold" Foreground="White"/>
                                                <TextBlock Text="Open a detected executable directly from here." Margin="0,6,0,0" Foreground="#8FA4B8" FontSize="12" TextWrapping="Wrap"/>
                                            </StackPanel>
                                            ...
                                            <Border Grid.Row="4"
                                                    ...
                                                    Padding="14">
                                                <StackPanel>
                                                    <TextBlock Text="Quick Notes" Foreground="White" FontSize="14" FontWeight="SemiBold"/>
                                                    <TextBlock Margin="0,8,0,0"
                                                               Text="After installing, choose a tool from the list to launch it directly."
                                                               Foreground="#93A7BA"
                                                               FontSize="12"
                                                               TextWrapping="Wrap"/>
                                                </StackPanel>
                                            ...
                                            <Button Grid.Row="6"
                                                    x:Name="OpenSelectedToolButton"
                                                    Content="Open Selected Tool"
