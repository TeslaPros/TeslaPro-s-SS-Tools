                                    ...
                                    <Border Margin="0,14,0,0" CornerRadius="14" Background="#101722" Padding="12" BorderBrush="#203042" BorderThickness="1">
                                        <Grid>
                                            ...
                                            <StackPanel>
                                                ...
                                                <TextBlock x:Name="VersionText" Text="Version 3.2" Foreground="#74E8FF" FontSize="16" FontWeight="Bold" Margin="0,4,0,0"/>
                                            </StackPanel>
...
function Hide-InfoOverlay {
    Hide-FadeElement -Element $InfoRoot -DurationMs 140
}
...
function Extract-Zip {
    ...
    $extractMethod = [System.IO.Compression.ZipFile].GetMethods() | Where-Object {
        $_.Name -eq 'ExtractToDirectory' -and $_.GetParameters().Count -eq 3
