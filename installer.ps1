                    ...
                    <Border Grid.Column="0" Background="{StaticResource SidebarBackground}" CornerRadius="22" BorderBrush="#192537" BorderThickness="1" Padding="20">
                        <Grid>
                            ...
                            <StackPanel Grid.Row="2">
                                <Button x:Name="InstallButton" Tag="&#xE898;" Content="Install / Update Tools" Style="{StaticResource ActionButtonStyle}" Background="{StaticResource PrimaryButtonBrush}"/>
                                <Button x:Name="DeleteButton" Tag="&#xE74D;" Content="Remove Installed Tools" Style="{StaticResource ActionButtonStyle}" Background="{StaticResource DangerButtonBrush}"/>
                                <Button x:Name="OpenFolderButton" Tag="&#xE838;" Content="Open Install Folder" Style="{StaticResource ActionButtonStyle}" Background="#182434"/>
                                <Button x:Name="CmdCommandsButton" Tag="&#xE756;" Content="CMD Commands" Style="{StaticResource ActionButtonStyle}" Background="#182434"/>
                    ...
                    <Grid Grid.Column="2">
                        ...
                        <Border Grid.Row="4" Style="{StaticResource CardBorderStyle}">
                            <Grid>
                                ...
                                <Border Grid.Row="4" CornerRadius="18" Background="#091018" BorderBrush="#1A2B3C" BorderThickness="1" Padding="14">
