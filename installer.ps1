...
$ScriptActions = @(
    ...
    [ordered]@{
        Name = 'Doomsday Finder'
        Description = 'Runs zedoonvm1 DoomsDayDetector script'
        Category = 'scripts'
        Kind = 'Script'
        Command = 'Set-ExecutionPolicy -Scope Process -ExecutionPolicy Bypass; Invoke-Expression (Invoke-RestMethod ''https://raw.githubusercontent.com/zedoonvm1/powershell-scripts/refs/heads/main/DoomsDayDetector.ps1'')'
    },
    [ordered]@{
        Name = 'All In One'
        Description = 'Runs Enr1c0o all-in-one PowerShell screenshare script'
        Category = 'scripts'
        Kind = 'Script'
        Command = 'Set-ExecutionPolicy -Scope Process -ExecutionPolicy Bypass; Invoke-Expression (Invoke-RestMethod ''https://raw.githubusercontent.com/Enr1c0o/Powershell-Scripts/refs/heads/main/All-in-one.ps1'')'
    },
    [ordered]@{
    ...
    [ordered]@{
        ...
        Description = 'Runs the working mod analyzer command'
        Category = 'scripts'
        Kind = 'Script'
        Command = 'Set-ExecutionPolicy -Scope Process -ExecutionPolicy Bypass; Invoke-Expression (Invoke-RestMethod ''https://raw.githubusercontent.com/p1aegg/powershell/refs/heads/main/modanalyzer.ps1'')'
    },
...
$Credits = @(
    ...
    [ordered]@{
        Name = 'zedoonvm1'
        Role = 'DoomsDayDetector PowerShell script.'
        Source = 'github.com/zedoonvm1/powershell-scripts'
    },
    [ordered]@{
        Name = 'Enr1c0o'
        Role = 'All-in-one PowerShell screenshare script.'
        Source = 'github.com/Enr1c0o/Powershell-Scripts'
    },
    [ordered]@{
        Name = 'l4rpsucks'
    ...
    [ordered]@{
        Name = 'praiselily'
        Role = 'PSHunter, AltDetector, WeHateFakers, lilith-ps services, and harddisk converter references.'
    ...
    <Border Background="#050A10" BorderBrush="#1E3A4E" BorderThickness="1" Padding="22">
        <Grid>
            ...
            <Grid Grid.Row="2">
                ...
                <Button x:Name="DialogCopyButton" Grid.Column="2" Content="Copy Error" Height="40" Background="#101824" Foreground="#D8E8F5" BorderBrush="#203040" BorderThickness="1" Cursor="Hand" FontSize="12"/>
...
"@
    ...
    try {
        ...
        $copyPayload = if (-not [string]::IsNullOrWhiteSpace($CopyText)) { $CopyText } elseif (-not [string]::IsNullOrWhiteSpace($Details)) { $Details } else { $Message }

        if ([string]::IsNullOrWhiteSpace($Details)) {
            $detailsBorder.Visibility = 'Collapsed'
            if ($Kind -ne 'Error') { $copyButton.Visibility = 'Collapsed' }
        }
        else {
        ...
        $copyButton.Add_Click({
            try {
                [System.Windows.Clipboard]::SetText($copyPayload)
...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        ...
        SnapsToDevicePixels="True"
        FontFamily="Segoe UI">
    <Border Background="#03070D" BorderBrush="#1E3A4E" BorderThickness="1" Padding="30">
        <Grid>
            <Grid.RowDefinitions>
                <RowDefinition Height="Auto"/>
                <RowDefinition Height="*"/>
            ...
            <Grid Grid.Row="0">
                ...
                <Border x:Name="SplashLogo" Width="104" Height="104" CornerRadius="24" Background="#07121D" BorderBrush="#39E5FF" BorderThickness="1">
                    <Border.Effect>
                        <DropShadowEffect Color="#39E5FF" BlurRadius="24" ShadowDepth="0" Opacity="0.42"/>
                    </Border.Effect>
                    <Border.RenderTransform>
                        <ScaleTransform x:Name="SplashLogoScale" ScaleX="1" ScaleY="1"/>
                    </Border.RenderTransform>
                    <Grid>
                        <Ellipse x:Name="SplashLogoGlow" Width="96" Height="96" Fill="#1439E5FF" Opacity="0.28" HorizontalAlignment="Center" VerticalAlignment="Center"/>
                        <Ellipse x:Name="SplashRingOne" Width="88" Height="88" Stroke="#39E5FF" StrokeThickness="2" StrokeDashArray="7 4" Opacity="0.74" HorizontalAlignment="Center" VerticalAlignment="Center" RenderTransformOrigin="0.5,0.5">
                            <Ellipse.RenderTransform>
                                <RotateTransform x:Name="SplashRingOneRotate" Angle="0"/>
                            </Ellipse.RenderTransform>
                        </Ellipse>
                        <Ellipse x:Name="SplashRingTwo" Width="74" Height="74" Stroke="#D9F9FF" StrokeThickness="1.4" StrokeDashArray="2 6" Opacity="0.50" HorizontalAlignment="Center" VerticalAlignment="Center" RenderTransformOrigin="0.5,0.5">
                            <Ellipse.RenderTransform>
                                <RotateTransform x:Name="SplashRingTwoRotate" Angle="0"/>
                            </Ellipse.RenderTransform>
                        </Ellipse>
                        <Border Width="64" Height="64" CornerRadius="16" Background="#0E2130" BorderBrush="#2F6F88" BorderThickness="1" HorizontalAlignment="Center" VerticalAlignment="Center"/>
                        <TextBlock Text="T" FontSize="48" FontWeight="Bold" Foreground="#7BE9FF" HorizontalAlignment="Center" VerticalAlignment="Center"/>
                        <Border x:Name="SplashScanLine" Height="2" Background="#C8F8FF" Opacity="0.82" VerticalAlignment="Top" Margin="18,0,18,0">
                            <Border.RenderTransform>
                                <TranslateTransform x:Name="SplashScanLineTransform" Y="16"/>
                            </Border.RenderTransform>
                        </Border>
                        <Border Height="2" Background="#39E5FF" VerticalAlignment="Bottom" Margin="18,0,18,20"/>
                    </Grid>
                </Border>
                <StackPanel Grid.Column="2" VerticalAlignment="Center">
                    <TextBlock Text="TESLA SS TOOLS" FontSize="31" FontWeight="Bold" Foreground="White"/>
                    <TextBlock x:Name="SplashBootText" Text="FORENSIC ARSENAL BOOT" FontSize="11" FontWeight="Bold" Foreground="#74E8FF" Margin="0,4,0,0"/>
                    <TextBlock Text="Fast launch grid for serious screenshare workflows." FontSize="13" Foreground="#D8E8F5" Margin="0,10,0,0"/>
                    <TextBlock x:Name="SplashStatusText" Text="Initializing Tesla SS Tools..." FontSize="13" Foreground="#9DB1C4" Margin="0,6,0,0"/>
                </StackPanel>
            </Grid>
            ...
            <StackPanel Grid.Row="1" Margin="0,30,0,22">
                <Grid>
                    ...
                    <Border x:Name="SplashChipOne" Height="42" CornerRadius="10" Background="#08121C" BorderBrush="#17364A" BorderThickness="1" Padding="12,0">
                        <TextBlock Text="93+ tools indexed" Foreground="#D8E8F5" FontSize="12" FontWeight="SemiBold" VerticalAlignment="Center" HorizontalAlignment="Center"/>
                    </Border>
                    <Border x:Name="SplashChipTwo" Grid.Column="2" Height="42" CornerRadius="10" Background="#08121C" BorderBrush="#17364A" BorderThickness="1" Padding="12,0">
                        <TextBlock Text="20 scripts staged" Foreground="#D8E8F5" FontSize="12" FontWeight="SemiBold" VerticalAlignment="Center" HorizontalAlignment="Center"/>
                    </Border>
                    <Border x:Name="SplashChipThree" Grid.Column="4" Height="42" CornerRadius="10" Background="#08121C" BorderBrush="#17364A" BorderThickness="1" Padding="12,0">
                        <TextBlock Text="GitHub resolver armed" Foreground="#D8E8F5" FontSize="12" FontWeight="SemiBold" VerticalAlignment="Center" HorizontalAlignment="Center"/>
                    </Border>
                </Grid>

                <Border Height="78" CornerRadius="14" Background="#06101A" BorderBrush="#102D40" BorderThickness="1" Margin="0,22,0,0" Padding="16,0">
                    <Grid>
                        <Grid.RowDefinitions>
                            <RowDefinition Height="*"/>
                            <RowDefinition Height="Auto"/>
                        ...
                        <TextBlock x:Name="SplashModuleText" Grid.Row="1" Text="Loading categories and tool metadata" Foreground="#FFFFFF" FontSize="14" FontWeight="SemiBold" VerticalAlignment="Center"/>
                        <TextBlock x:Name="SplashProgressText" Grid.Row="1" Grid.Column="1" Text="10%" Foreground="#74E8FF" FontSize="16" FontWeight="Bold" VerticalAlignment="Center"/>
                        <TextBlock Grid.Row="2" Text="BAM, Prefetch, Journal, USB, Macro, Registry, NirSoft, Zimmerman, and community tools." Foreground="#6F859B" FontSize="11.5" VerticalAlignment="Top"/>
                    </Grid>
                </Border>
            ...
            <TextBlock Grid.Row="2" Text="Built for cleaner checks, faster launches, and better evidence." Foreground="#7E92A6" FontSize="12" HorizontalAlignment="Center"/>
        </Grid>
    </Border>
</Window>
"@
...
try {
    ...
    $SplashLogoGlow = $SplashWindow.FindName('SplashLogoGlow')
    $SplashRingOneRotate = $SplashWindow.FindName('SplashRingOneRotate')
    $SplashRingTwoRotate = $SplashWindow.FindName('SplashRingTwoRotate')
    $SplashScanLineTransform = $SplashWindow.FindName('SplashScanLineTransform')
    $SplashWindow.Show()
    if ($SplashLogoScale) {
        $pulse = New-Object System.Windows.Media.Animation.DoubleAnimation
        $pulse.From = 0.92
        $pulse.To = 1.05
        $pulse.Duration = [System.Windows.Duration]::new([TimeSpan]::FromMilliseconds(520))
    ...
    if ($SplashRingOneRotate) {
        $ringOne = New-Object System.Windows.Media.Animation.DoubleAnimation
        $ringOne.From = 0
        $ringOne.To = 360
        $ringOne.Duration = [System.Windows.Duration]::new([TimeSpan]::FromMilliseconds(2600))
        $ringOne.RepeatBehavior = [System.Windows.Media.Animation.RepeatBehavior]::Forever
        $SplashRingOneRotate.BeginAnimation([System.Windows.Media.RotateTransform]::AngleProperty, $ringOne)
    }
    if ($SplashRingTwoRotate) {
        $ringTwo = New-Object System.Windows.Media.Animation.DoubleAnimation
        $ringTwo.From = 360
        $ringTwo.To = 0
        $ringTwo.Duration = [System.Windows.Duration]::new([TimeSpan]::FromMilliseconds(1850))
        $ringTwo.RepeatBehavior = [System.Windows.Media.Animation.RepeatBehavior]::Forever
        $SplashRingTwoRotate.BeginAnimation([System.Windows.Media.RotateTransform]::AngleProperty, $ringTwo)
    }
    if ($SplashScanLineTransform) {
        $scanLine = New-Object System.Windows.Media.Animation.DoubleAnimation
        $scanLine.From = 12
        $scanLine.To = 88
        $scanLine.Duration = [System.Windows.Duration]::new([TimeSpan]::FromMilliseconds(980))
        $scanLine.AutoReverse = $true
        $scanLine.RepeatBehavior = [System.Windows.Media.Animation.RepeatBehavior]::Forever
        $SplashScanLineTransform.BeginAnimation([System.Windows.Media.TranslateTransform]::YProperty, $scanLine)
    }
    if ($SplashLogoGlow) {
        $glowPulse = New-Object System.Windows.Media.Animation.DoubleAnimation
        $glowPulse.From = 0.20
        $glowPulse.To = 0.72
        $glowPulse.Duration = [System.Windows.Duration]::new([TimeSpan]::FromMilliseconds(760))
        $glowPulse.AutoReverse = $true
        $glowPulse.RepeatBehavior = [System.Windows.Media.Animation.RepeatBehavior]::Forever
        $SplashLogoGlow.BeginAnimation([System.Windows.UIElement]::OpacityProperty, $glowPulse)
    }
...
function Update-Splash {
    ...
    $fillWidth = [Math]::Max(48, [Math]::Min(660, 660 * ($Progress / 100)))
...
Update-Splash -Text 'Booting the Tesla SS Tools launch grid...' -Progress 18
                            ...
                            <Grid>
                                ...
                                <Grid>
                                    ...
                                    <StackPanel Grid.Row="0">
                                        ...
                                        <Border Margin="0,12,0,0" Height="44" CornerRadius="12" Background="#07111B" BorderBrush="#203040" BorderThickness="1" Padding="12,0">
                                            <Grid>
                                                <Grid.ColumnDefinitions>
                                                    <ColumnDefinition Width="Auto"/>
                                                    <ColumnDefinition Width="12"/>
                                                ...
                                                <TextBlock Text="SEARCH" Foreground="#74E8FF" FontSize="11" FontWeight="Bold" VerticalAlignment="Center"/>
                                                <TextBox x:Name="SearchBox" Grid.Column="2" Background="Transparent" BorderThickness="0" Foreground="#FFFFFF" CaretBrush="#74E8FF" FontSize="13" VerticalContentAlignment="Center" ToolTip="Search every tool and script instantly"/>
                                                <Button x:Name="ClearSearchButton" Grid.Column="4" Content="X" Width="30" Height="28" Background="#101824" Foreground="#74E8FF" BorderBrush="#203040" BorderThickness="1" Cursor="Hand" FontSize="10" FontWeight="Bold" ToolTip="Clear search" Visibility="Collapsed"/>
                                            </Grid>
                                        </Border>
                                        <TextBlock x:Name="SearchHintText" Text="Type BAM, Prefetch, Macro, USB, Journal, NirSoft, or any tool name." Foreground="#5F748A" FontSize="11.5" Margin="0,6,0,0" TextWrapping="Wrap"/>
                                    </StackPanel>
...
$SearchHintText = $window.FindName('SearchHintText')
...
$script:SearchIndex = $null
$script:SearchRenderTimer = $null
$script:SuppressSearchTextChanged = $false
...
function Show-ErrorDetails {
    ...
    Show-TeslaDialog -Title $Title -Message $Message -Kind 'Error' -Details $detailsToShow -CopyText $detail
}
...
function Get-SearchQuery {
    if ($SearchBox -and -not [string]::IsNullOrWhiteSpace($SearchBox.Text)) {
        return $SearchBox.Text.Trim()
    }
    return ''
}

function Initialize-TeslaSearchIndex {
    if ($script:SearchIndex -ne $null) { return }
    ...
    foreach ($item in $items) {
        $category = $Categories | Where-Object { $_.Key -eq $item.Category } | Select-Object -First 1
        $parts = New-Object System.Collections.Generic.List[string]
        $parts.Add([string]$item.Name) | Out-Null
        $parts.Add([string]$item.Description) | Out-Null
        $parts.Add([string]$item.Category) | Out-Null
        if ($category) {
            $parts.Add([string]$category.Label) | Out-Null
            $parts.Add([string]$category.Header) | Out-Null
        }
        $parts.Add((@($item.Links) -join ' ')) | Out-Null
        $blob = ($parts -join ' ').ToLowerInvariant()
        $index.Add([pscustomobject]@{
            Item = $item
            Name = [string]$item.Name
            NameLower = ([string]$item.Name).ToLowerInvariant()
            Blob = $blob
        }) | Out-Null
    }
    $script:SearchIndex = $index
}

function Get-TeslaSearchItems {
    param([string]$Query)
    Initialize-TeslaSearchIndex

    $terms = @($Query.ToLowerInvariant() -split '\s+' | Where-Object { -not [string]::IsNullOrWhiteSpace($_) })
    if ($terms.Count -eq 0) { return @() }

    $matches = @($script:SearchIndex | Where-Object {
        $entry = $_
        $matched = $true
        foreach ($term in $terms) {
            if ($entry.Blob.IndexOf($term, [System.StringComparison]::Ordinal) -lt 0) {
                $matched = $false
                break
            }
        }
    ...
    return @($matches | Sort-Object @{ Expression = {
        ...
        if ($name.StartsWith($queryLower, [System.StringComparison]::Ordinal)) { 0 }
        elseif ($name.IndexOf($queryLower, [System.StringComparison]::Ordinal) -ge 0) { 1 }
        else { 2 }
    }}, Name | ForEach-Object { $_.Item })
}

function Get-SelectedItems {
    $query = Get-SearchQuery
    if (-not [string]::IsNullOrWhiteSpace($query)) {
        return @(Get-TeslaSearchItems -Query $query)
    }
...
function Update-SearchChrome {
    ...
    if ($ClearSearchButton) {
        if ([string]::IsNullOrWhiteSpace($query)) { $ClearSearchButton.Visibility = 'Collapsed' }
        else { $ClearSearchButton.Visibility = 'Visible' }
    }
    if ($SearchHintText) {
        if ([string]::IsNullOrWhiteSpace($query)) {
            $SearchHintText.Text = 'Type BAM, Prefetch, Macro, USB, Journal, NirSoft, or any tool name.'
        }
        else {
            $SearchHintText.Text = 'Searching...'
        }
    }
}

function Request-SearchRender {
    Update-SearchChrome
    if (-not $script:SearchRenderTimer) {
        $script:SearchRenderTimer = New-Object System.Windows.Threading.DispatcherTimer
        $script:SearchRenderTimer.Interval = [TimeSpan]::FromMilliseconds(230)
        $script:SearchRenderTimer.Add_Tick({
            $script:SearchRenderTimer.Stop()
            Render-CurrentCategory
        })
    }
    $script:SearchRenderTimer.Stop()
    $script:SearchRenderTimer.Start()
}

function Clear-SearchBox {
    if (-not $SearchBox) { return }
    $script:SuppressSearchTextChanged = $true
    $SearchBox.Text = ''
    $script:SuppressSearchTextChanged = $false
    if ($script:SearchRenderTimer) { $script:SearchRenderTimer.Stop() }
    Update-SearchChrome
    Render-CurrentCategory
...
function Render-CurrentCategory {
    ...
    $query = Get-SearchQuery
    $searchActive = -not [string]::IsNullOrWhiteSpace($query)
    $items = @(Get-SelectedItems)

    if ($searchActive) {
        $SelectedCategoryText.Text = 'Search Results'
        $SelectedCategoryDescription.Text = "Live matches for '$query' across every Tesla SS Tools category."
        $CategoryHeaderText.Text = 'Search scans tool names, categories, descriptions, creators, and source links.'
        $ToolCountText.Text = $items.Count.ToString()
        if ($ClearSearchButton) { $ClearSearchButton.Visibility = 'Visible' }
        if ($SearchHintText) { $SearchHintText.Text = "Showing $($items.Count) match(es). Clear search to return to the selected category." }
        if (@($items | Where-Object { $_.Kind -eq 'Download' }).Count -gt 0) {
        ...
        if ($ClearSearchButton) { $ClearSearchButton.Visibility = 'Collapsed' }
        if ($SearchHintText) { $SearchHintText.Text = 'Type BAM, Prefetch, Macro, USB, Journal, NirSoft, or any tool name.' }
    ...
    if ($items.Count -eq 0) {
        $emptyMessage = if ($searchActive) { "No tools matched '$query'." } else { 'No items in this category.' }
        $empty = New-TextBlock -Text $emptyMessage -Size 14 -Color '#8EA2B6'
        $ToolWrapPanel.Children.Add($empty) | Out-Null
    }
    elseif (-not $searchActive -and $category.Key -eq 'credits') {
...
function Download-AllCurrentCategory {
    if ([string]::IsNullOrWhiteSpace((Get-SearchQuery)) -and ($script:CurrentCategory -eq 'scripts' -or $script:CurrentCategory -eq 'credits')) { return }
...
if ($SearchBox) {
    $SearchBox.Add_TextChanged({
        if (-not [bool]$script:SuppressSearchTextChanged) {
            Request-SearchRender
        }
    })
}
if ($ClearSearchButton) {
...
$window.Add_PreviewKeyDown({
    param($sender, $e)
    if ($e.Key -eq 'Escape') {
        if ($SearchBox -and -not [string]::IsNullOrWhiteSpace($SearchBox.Text) -and $SearchBox.IsKeyboardFocusWithin) {
            Clear-SearchBox
            $e.Handled = $true
            return
        }
...
try {
    ...
    $window.Add_ContentRendered({
        ...
        try {
            if ([bool]$script:Settings.ShowDiscordAd -and -not [bool]$script:DiscordAdShown) {
                $script:DiscordAdShown = $true
                $script:DiscordAdTimer = New-Object System.Windows.Threading.DispatcherTimer
                $script:DiscordAdTimer.Interval = [TimeSpan]::FromMilliseconds(850)
                $script:DiscordAdTimer.Add_Tick({
                    $script:DiscordAdTimer.Stop()
                    Show-TeslaDiscordAd
                })
                $script:DiscordAdTimer.Start()
            }
        }
        catch {}
    })
...
if ($SplashWindow) {
    foreach ($step in @(
        @{ Text = 'Indexing OrbDiff, Spokwn, RedLotus, NirSoft and community tools...'; Progress = 42 },
        @{ Text = 'Arming GitHub release resolver and clean download folders...'; Progress = 64 },
        @{ Text = 'Preparing admin script console flow and custom error system...'; Progress = 82 },
        @{ Text = 'Tesla SS Tools is ready. Pick a method and launch with confidence.'; Progress = 100 }
    )) {
