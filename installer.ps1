dd-Type -AssemblyName PresentationFramework
...
function Start-CmdCommands {
    ...
    try {
        ...
        Show-AppMessage "Tool Update" "TeslaPro SS Tools has been updated.`n`nNew in this update:`n• Added a Doomsday finder tool with the full 190k string database.`n• Added a common bypass detection tool for screenshare checks.`n`nYou can find both new .exe files inside the SS TeslaPro folder after downloading the tools.`n`nThank you for using TeslaPro SS Tools." "Info"
    }
    catch {
