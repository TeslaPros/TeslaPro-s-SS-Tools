                                    ...
                                    <Border Margin="0,14,0,0" CornerRadius="14" Background="#101722" Padding="12" BorderBrush="#203042" BorderThickness="1">
                                        <Grid>
                                            ...
                                            <StackPanel>
                                                ...
                                                <TextBlock x:Name="VersionText" Text="Version 5.3" Foreground="#74E8FF" FontSize="16" FontWeight="Bold" Margin="0,4,0,0"/>
                                            </StackPanel>
...
Please keep this launcher private and use it responsibly. If anything is unclear, contact TeslaPro before using or sharing the tools.
        ...
        <Grid x:Name="PopupRoot" Visibility="Collapsed" Background="#A0000000">
            <Border Width="520"
                    Padding="22"
                    CornerRadius="22"
                    Background="#0D141D"
        ...
        <Grid x:Name="ConfirmRoot" Visibility="Collapsed" Background="#A0000000">
            <Border Width="540"
                    Padding="22"
                    CornerRadius="22"
                    Background="#0D141D"
...
function Show-AppMessage {
    ...
    $PopupRoot.Visibility = "Visible"
}

function Hide-AppMessage {
    $PopupRoot.Visibility = "Collapsed"
}
...
function Hide-ConfirmDialog {
    $ConfirmRoot.Visibility = "Collapsed"
}
...
function Show-ConfirmDialog {
    ...
    $script:ConfirmDialogResult = $null
    $ConfirmRoot.Visibility = "Visible"
    Refresh-Ui
