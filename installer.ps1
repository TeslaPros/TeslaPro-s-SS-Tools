...
$AppRoot = Join-Path $ScriptRoot 'Tesla SS Tools'
...
$Categories = @(
    ...
    [ordered]@{
        Key = 'credits'
        Label = 'Credits'
        Header = 'Credits and attribution'
        Description = 'Original application, GUI reference, external developers, repositories, and project owners preserved from the uploaded source.'
    }
)
...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        ...
        Topmost="True"
        FontFamily="Segoe UI">
    <Border CornerRadius="24" Background="#050A10" BorderBrush="#1E3A4E" BorderThickness="1" Padding="26">
        <Border.Effect>
            <DropShadowEffect BlurRadius="28" ShadowDepth="0" Opacity="0.45"/>
        </Border.Effect>
        <Grid>
            <Grid.RowDefinitions>
            ...
            <StackPanel Orientation="Horizontal">
                <Border Width="48" Height="48" CornerRadius="15" Background="#101A27" BorderBrush="#23435D" BorderThickness="1">
                ...
                <StackPanel Margin="14,0,0,0" VerticalAlignment="Center">
                    ...
                    <TextBlock Text="Loading UI..." FontSize="12" Foreground="#8EA2B6" Margin="0,4,0,0"/>
                </StackPanel>
            </StackPanel>
            <Grid Grid.Row="1" Margin="0,26,0,18">
                <Ellipse Width="150" Height="150" Fill="#1DDCFF" Opacity="0.05" HorizontalAlignment="Left" Margin="-30,-20,0,0"/>
                <Ellipse Width="120" Height="120" Fill="#0E86FF" Opacity="0.06" HorizontalAlignment="Right" VerticalAlignment="Bottom" Margin="0,0,-20,-30"/>
                <ProgressBar Width="260" Height="8" IsIndeterminate="True" Foreground="#22D6FF" Background="#091018" BorderThickness="0" HorizontalAlignment="Center" VerticalAlignment="Center"/>
            </Grid>
            <TextBlock Grid.Row="2" Text="Preparing standalone PowerShell application" Foreground="#7E92A6" FontSize="12" HorizontalAlignment="Center"/>
        </Grid>
    </Border>
</Window>
"@
    ...
    <Window.Resources>
        ...
        <Style x:Key="ToolCardButtonStyle" TargetType="Button">
            ...
            <Setter Property="Template">
                <Setter.Value>
                    <ControlTemplate TargetType="Button">
                        <Border x:Name="Root" Background="{TemplateBinding Background}" CornerRadius="18" BorderBrush="#203040" BorderThickness="1" Padding="14">
                            <ContentPresenter/>
                        </Border>
                        <ControlTemplate.Triggers>
                            <Trigger Property="IsMouseOver" Value="True">
    ...
    <Grid>
        <Border CornerRadius="24" Background="{StaticResource WindowBackground}" BorderBrush="#1D2938" BorderThickness="1">
            ...
            <Grid>
                ...
                <Ellipse Width="560" Height="560" Fill="#1DDCFF" Opacity="0.055" HorizontalAlignment="Left" VerticalAlignment="Top" Margin="-190,-180,0,0"/>
                <Ellipse Width="430" Height="430" Fill="#0E86FF" Opacity="0.045" HorizontalAlignment="Right" VerticalAlignment="Bottom" Margin="0,0,-120,-130"/>
                ...
                <Border x:Name="HeaderBar" Grid.Row="0" Background="#0A0F17" CornerRadius="24,24,0,0" BorderBrush="#162232" BorderThickness="0,0,0,1">
                    <Grid Margin="18,0,18,0">
                        ...
                        <StackPanel Grid.Column="2" Orientation="Horizontal" VerticalAlignment="Center">
                            ...
                            <Button x:Name="CreditsTopButton" Content="i" Style="{StaticResource SmallWindowButtonStyle}" Background="#163043"/>
                    ...
                    <Border Grid.Column="0" Background="{StaticResource SidebarBackground}" CornerRadius="22" BorderBrush="#192537" BorderThickness="1" Padding="20">
                        <Grid>
                            ...
                            <StackPanel>
                                ...
                                <TextBlock Text="Choose a category, download tools, launch scanners, or run original scripts." TextWrapping="Wrap" Margin="0,8,0,0" Foreground="#8EA2B6" FontSize="13"/>
                            </StackPanel>
                            ...
                            <Border Grid.Row="4" Background="#0B1017" CornerRadius="18" Padding="16" BorderBrush="#1B2837" BorderThickness="1">
                                <Grid>
                                    ...
                                    <StackPanel>
                                        <TextBlock Text="Version" Foreground="#7A92A8" FontSize="11"/>
                        ...
                        <Border Grid.Row="0" Style="{StaticResource CardBorderStyle}">
                            <Grid>
                                ...
                                <StackPanel>
                                    ...
                                    <TextBlock x:Name="CategoryHeaderText" Text="Tools developed by OrbDiff - github.com/orbdiff" Margin="0,14,0,0" FontSize="13" Foreground="#74E8FF" TextWrapping="Wrap"/>
                                </StackPanel>
                                <StackPanel Grid.Column="1" VerticalAlignment="Center">
                                    <TextBlock Text="Panel Status" Foreground="#7990A5" FontSize="12" HorizontalAlignment="Center"/>
                        ...
                        <Border Grid.Row="2" Style="{StaticResource CardBorderStyle}">
                            <Grid>
                                ...
                                <Grid>
                                    ...
                                    <StackPanel>
                                        <TextBlock x:Name="SelectedCategoryText" Text="OrbDiff" FontSize="22" FontWeight="SemiBold" Foreground="White"/>
                                        <TextBlock x:Name="SelectedCategoryDescription" Text="Tools developed by OrbDiff" Foreground="#91A7BB" FontSize="12" Margin="0,6,0,0" TextWrapping="Wrap"/>
                                    </StackPanel>
                                    <StackPanel Grid.Column="1" Orientation="Horizontal" HorizontalAlignment="Right" VerticalAlignment="Top">
                                        <Button x:Name="OpenToolsFolderButton" Content="Open Folder" Style="{StaticResource ActionButtonStyle}" Width="128" Margin="0,0,10,0"/>
                                ...
                                <ScrollViewer Grid.Row="2" VerticalScrollBarVisibility="Auto" HorizontalScrollBarVisibility="Disabled">
                                    <WrapPanel x:Name="ToolWrapPanel"/>
                                </ScrollViewer>
                            </Grid>
                        </Border>
...
$CreditsTopButton = $window.FindName('CreditsTopButton')
...
function Get-DownloadTargets {
    param($Tool)
    $destDir = Join-Path $ToolsRoot $Tool.Category
...
function New-ToolCard {
    ...
    $button.Width = 252
    $button.Height = 126
    $button.Margin = New-Object System.Windows.Thickness 0,0,12,12
    ...
    $col2.Width = New-Object System.Windows.GridLength 18
    $nameGrid.ColumnDefinitions.Add($col1) | Out-Null
    $nameGrid.ColumnDefinitions.Add($col2) | Out-Null

    $name = New-TextBlock -Text $Item.Name -Size 14 -Color '#FFFFFF' -Weight 'SemiBold'
    $name.TextTrimming = 'CharacterEllipsis'
    [System.Windows.Controls.Grid]::SetColumn($name, 0)
    $nameGrid.Children.Add($name) | Out-Null

    $dot = New-Object System.Windows.Controls.Border
    $dot.Width = 9
    $dot.Height = 9
    $dot.CornerRadius = New-Object System.Windows.CornerRadius 5
    $dot.Background = Get-Brush '#2A3A4D'
    $dot.HorizontalAlignment = 'Right'
    $dot.VerticalAlignment = 'Center'
    [System.Windows.Controls.Grid]::SetColumn($dot, 1)
    $nameGrid.Children.Add($dot) | Out-Null

    $desc = New-TextBlock -Text $Item.Description -Size 12 -Color '#9DB1C4'
    ...
    $progress.Value = 0
    $progress.Height = 4
    $progress.Margin = New-Object System.Windows.Thickness 0,8,0,0
...
function Start-NextDownload {
    ...
    $worker.Add_RunWorkerCompleted({
        ...
        if (-not $jobDone) {
            ...
            $script:ActiveDownloadJob = $null
            $CancelDownloadButton.IsEnabled = $false
            Set-UiState -Title 'Download stopped' -SubTitle 'The download ended without a job result.' -Chip 'Ready' -Step 'Stopped' -Progress 0
...
function Start-DownloadedTool {
    ...
    try {
        ...
        Show-Message -Message "Could not launch $Name.`r`n`r`n$($_.Exception.Message)" -Icon 'Error'
    }
}
...
function Start-ScriptAction {
    ...
    try {
        ...
        Show-Message -Message "Could not launch $($ScriptItem.Name).`r`n`r`n$($_.Exception.Message)" -Icon 'Error'
    }
}
...
function Open-ToolsFolder {
    try {
        ...
        Show-Message -Message $_.Exception.Message -Icon 'Error'
    }
}
...
function Open-DiscordInvite {
    try {
        ...
        Show-Message -Message "Could not open Discord invite.`r`n`r`n$($_.Exception.Message)" -Icon 'Error'
    }
}
...
$CreditsTopButton.Add_Click({ Switch-Category -Key 'credits' })
