...
<Window
    ...
    <Grid>
                    ...
                    <Grid Margin="18,0,18,0">
                        ...
                        <StackPanel Orientation="Horizontal" VerticalAlignment="Center">
                            ...
                            <StackPanel Margin="12,0,0,0" VerticalAlignment="Center">
                                <TextBlock Text="TeslaPro's SS Tools Downloader" FontSize="18" FontWeight="SemiBold" Foreground="White"/>
                                <TextBlock Text="Toolkit launcher" FontSize="11" Foreground="#7E92A6" Margin="0,2,0,0"/>
                            </StackPanel>
                        </StackPanel>
                                    ...
                                    <Border Margin="0,14,0,0" CornerRadius="14" Background="#101722" Padding="12" BorderBrush="#203042" BorderThickness="1">
                                        <Grid>
                                            ...
                                            <StackPanel>
                                                ...
                                                <TextBlock x:Name="VersionText" Text="Version 5.1" Foreground="#74E8FF" FontSize="16" FontWeight="Bold" Margin="0,4,0,0"/>
                                            </StackPanel>
                            ...
                            <Grid>
                                ...
                                <Border Grid.Column="1" HorizontalAlignment="Right" Width="260" Height="110" CornerRadius="22" Background="#0B1119" BorderBrush="#1E3145" BorderThickness="1">
                                    <Grid Margin="16">
                                        ...
                                        <TextBlock Text="Current State" Foreground="#7990A5" FontSize="12"/>
        ...
        <Grid x:Name="OverlayRoot" Visibility="Collapsed" Background="#A0000000">
            <Border Width="620"
                    Padding="24"
                    CornerRadius="22"
                    Background="#0D141D"
                ...
                <Grid>
                    ...
                    <Grid>
                        ...
                        <StackPanel Grid.Column="1" Margin="14,0,0,0">
                            ...
                            <TextBlock Text="TeslaPro SS Tools information" Foreground="#8FA4B8" FontSize="12" Margin="0,4,0,0"/>
                        </StackPanel>
...
This launcher was made for TeslaPro.
...
function Show-InfoOverlay {
    $OverlayRoot.Visibility = "Visible"
}

function Hide-InfoOverlay {
    $OverlayRoot.Visibility = "Collapsed"
}
    ...
    try {
        ...
        if (Test-Path $dest) {
            $overwrite = [System.Windows.MessageBox]::Show(
                "An existing install was found.`n`nDo you want to replace it?",
                "TeslaPro Launcher",
        ...
        Show-AppMessage "Install Complete" "TeslaPro SS Tools were installed successfully." "Information"
    }
    catch {
...
function Remove-Tools {
    try {
        ...
        $confirm = [System.Windows.MessageBox]::Show(
            "This will remove TeslaPro SS Tools from:`n`n$dest`n`nContinue?",
            "Confirm Removal",
            [System.Windows.MessageBoxButton]::YesNo,
        ...
        Show-AppMessage "Removal Complete" "TeslaPro SS Tools were removed successfully." "Information"
    }
    catch {
...
$OpenFolderButton.Add_Click({
    try {
        if (!(Test-Path $dest)) {
            Show-AppMessage "Open Folder" "The install folder does not exist yet." "Information"
            return
        }
...
$DiscordCopyButton.Add_Click({
    try {
        ...
        Show-AppMessage "Copied" "Discord tag copied: @teamwsf" "Information"
    }
    catch {
