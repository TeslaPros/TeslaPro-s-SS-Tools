...
<Window
    ...
    <Window.Resources>
        <LinearGradientBrush x:Key="WindowBackground" StartPoint="0,0" EndPoint="1,1">
            ...
            <GradientStop Color="#09111A" Offset="0.45"/>
        ...
        <LinearGradientBrush x:Key="PrimaryButtonBrush" StartPoint="0,0" EndPoint="1,1">
            <GradientStop Color="#38E4FF" Offset="0"/>
            <GradientStop Color="#00A7D7" Offset="1"/>
        </LinearGradientBrush>
                            ...
                            <Grid>
                                ...
                                <StackPanel>
                                    ...
                                    <Border Margin="0,18,0,0" CornerRadius="14" Background="#0B121B" Padding="12" BorderBrush="#1A293A" BorderThickness="1">
                                        <TextBlock Text="A cleaner and more stable launcher for TeslaPro SS Tools." Foreground="#84A1BA" TextWrapping="Wrap"/>
                                    </Border>
                                </StackPanel>
...
function Install-Tools {
    ...
    $script:InstallWorker = New-LauncherWorker
    ...
    $script:InstallWorker.add_DoWork({
        ...
        try {
            $sender.ReportProgress(10, @{
                ...
                Sub   = "Making sure everything is ready."
                Chip  = "Checking"
                Step  = "System Check"
            })
            ...
            $sender.ReportProgress(34, @{
                Title = "Downloading package"
                Sub   = "Getting the latest TeslaPro release."
                Chip  = "Downloading"
                Step  = "Download"
            })
            ...
            Download-FileFast -SourceUrl $url -OutFile $zip
            ...
            if ($zipItem.Length -lt 1000) {
                throw "The downloaded ZIP looks invalid or corrupted."
            }

            $sender.ReportProgress(64, @{
                Title = "Installing files"
                Sub   = "Unpacking the toolkit and preparing the folder."
                Chip  = "Installing"
                Step  = "Extracting"
            })

            Extract-ZipFast -ZipPath $zip -Destination $dest
    ...
    $script:InstallWorker.add_RunWorkerCompleted({
        ...
        try {
            ...
            $ToolCountText.Text = $result.ToolCount.ToString()
...
function Remove-Tools {
    ...
    $script:RemoveWorker = New-LauncherWorker
