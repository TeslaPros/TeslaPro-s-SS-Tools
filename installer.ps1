if (-not $env:TESLA_LAUNCHER_HIDDEN) {
    try {
        $scriptText = $MyInvocation.MyCommand.Definition
        if (-not [string]::IsNullOrWhiteSpace($scriptText)) {
            $bytes = [System.Text.Encoding]::Unicode.GetBytes('$env:TESLA_LAUNCHER_HIDDEN="1";' + $scriptText)
...
<Window
    ...
    <Window.Resources>
        ...
        <Style x:Key="UtilityButtonStyle" TargetType="Button">
            ...
            <Setter Property="Cursor" Value="Hand"/>
            <Setter Property="BorderThickness" Value="0"/>
            <Setter Property="Background" Value="#162231"/>
            <Setter Property="Template">
                <Setter.Value>
                    <ControlTemplate TargetType="Button">
                        <Border x:Name="Root"
                    ...
                    <Border Grid.Column="0" Background="{StaticResource SidebarBackground}" CornerRadius="22" BorderBrush="#192537" BorderThickness="1" Padding="20">
                        <Grid>
                            ...
                            <StackPanel Grid.Row="2">
                                ...
                                <Button x:Name="RefreshToolsButton"
                                        Tag="&#xE72C;"
                                    ...
                                    <Border Margin="0,14,0,0" CornerRadius="14" Background="#101722" Padding="12" BorderBrush="#203042" BorderThickness="1">
                                        <Grid>
                                            ...
                                            <StackPanel>
                                                ...
                                                <TextBlock x:Name="VersionText" Text="Version 3.0" Foreground="#74E8FF" FontSize="16" FontWeight="Bold" Margin="0,4,0,0"/>
                                            </StackPanel>
                        ...
                        <Border Grid.Row="4" Style="{StaticResource CardBorderStyle}">
                            <Grid>
                                ...
                                <Grid>
                                    ...
                                    <StackPanel>
                                        <TextBlock Text="Installed Tools" FontSize="22" FontWeight="SemiBold" Foreground="White"/>
                                        <TextBlock Text="Detected executables in the install folder" Foreground="#91A7BB" FontSize="12" Margin="0,6,0,0"/>
                                    </StackPanel>
                                ...
                                <StackPanel Grid.Row="4" Orientation="Horizontal">
                                    <Button x:Name="OpenSelectedToolButton" Content="Open Selected Tool" Style="{StaticResource UtilityButtonStyle}" Width="170"/>
                                    <Button x:Name="CopyDebugButton" Content="Copy Debug Info" Style="{StaticResource UtilityButtonStyle}" Width="150"/>
                                </StackPanel>

                                <Border Grid.Row="6" CornerRadius="16" Background="#091018" BorderBrush="#1A2B3C" BorderThickness="1" Padding="10">
                                    <Grid>
                                        <Grid.ColumnDefinitions>
                                            <ColumnDefinition Width="*"/>
                                        ...
                                        <Border Grid.Column="1"
                                                ...
                                                Padding="14">
                                            <StackPanel>
                                                <TextBlock Text="Selection" FontSize="15" FontWeight="SemiBold" Foreground="White"/>
                                                <TextBlock x:Name="SelectedToolNameText"
                                                           Margin="0,12,0,0"
                                                           Text="No tool selected"
                                                           TextWrapping="Wrap"
                                                           Foreground="#DCE7F2"
                                                           FontSize="13"/>
                                                <TextBlock x:Name="SelectedToolPathText"
                                                           Margin="0,10,0,0"
                                                           Text=""
                                                           TextWrapping="Wrap"
                                                           Foreground="#8FA4B8"
...
Please keep this launcher private and use it responsibly. If anything is unclear, contact TeslaPro before using or sharing the tools.
            ...
            <Border Width="520" Padding="22" CornerRadius="22" Background="#0D141D" BorderBrush="#203447" BorderThickness="1" HorizontalAlignment="Center" VerticalAlignment="Center">
                ...
                <Grid>
                    ...
                    <Grid>
                        ...
                        <StackPanel Grid.Column="1" Margin="14,0,0,0">
                            <TextBlock x:Name="PopupTitleText" Text="Message" FontSize="22" FontWeight="SemiBold" Foreground="White"/>
                            <TextBlock x:Name="PopupSubtitleText" Text="Tesla Launcher" Foreground="#8FA4B8" FontSize="12" Margin="0,4,0,0"/>
                        </StackPanel>
                    ...
                    <Border Grid.Row="2" CornerRadius="16" Background="#0A1018" BorderBrush="#1C2E40" BorderThickness="1" Padding="16">
                        <TextBlock x:Name="PopupMessageText" TextWrapping="Wrap" Foreground="#DCE7F2" FontSize="13" Text="Message goes here."/>
                    </Border>
        ...
        <Grid x:Name="ConfirmRoot" Visibility="Collapsed" Opacity="0" Background="#A0000000">
            <Border Width="540" Padding="22" CornerRadius="22" Background="#0D141D" BorderBrush="#203447" BorderThickness="1" HorizontalAlignment="Center" VerticalAlignment="Center">
                <Border.Effect>
                    <DropShadowEffect BlurRadius="30" ShadowDepth="0" Opacity="0.35"/>
                </Border.Effect>
                <Grid>
                    ...
                    <Grid>
                        ...
                        <Border Width="44" Height="44" CornerRadius="14" Background="#112130" BorderBrush="#28445C" BorderThickness="1">
                            <TextBlock x:Name="ConfirmIconText" Text="?" HorizontalAlignment="Center" VerticalAlignment="Center" FontSize="20" FontWeight="Bold" Foreground="#FFC857"/>
                        </Border>

                        <StackPanel Grid.Column="1" Margin="14,0,0,0">
                            <TextBlock x:Name="ConfirmTitleText" Text="Please Confirm" FontSize="22" FontWeight="SemiBold" Foreground="White"/>
                            <TextBlock x:Name="ConfirmSubtitleText" Text="Tesla Launcher" Foreground="#8FA4B8" FontSize="12" Margin="0,4,0,0"/>
                        </StackPanel>

                        <Button x:Name="ConfirmCloseButton" Grid.Column="2" Content="✕" Width="34" Height="34" Style="{StaticResource SmallWindowButtonStyle}" Background="#1F2330"/>
                    </Grid>

                    <Border Grid.Row="2" CornerRadius="16" Background="#0A1018" BorderBrush="#1C2E40" BorderThickness="1" Padding="16">
                        <TextBlock x:Name="ConfirmMessageText" TextWrapping="Wrap" Foreground="#DCE7F2" FontSize="13" Text="Confirmation text goes here."/>
                    </Border>

                    <StackPanel Grid.Row="4" Orientation="Horizontal" HorizontalAlignment="Right">
                        <Button x:Name="ConfirmNoButton" Tag="&#xE711;" Content="Cancel" Style="{StaticResource ActionButtonStyle}" Background="#172231" Width="140" Margin="0,0,12,0"/>
                        <Button x:Name="ConfirmYesButton" Tag="&#xE73E;" Content="Continue" Style="{StaticResource ActionButtonStyle}" Background="{StaticResource PrimaryButtonBrush}" Width="150" Margin="0"/>
                    </StackPanel>
                </Grid>
            </Border>
        </Grid>
...
$RefreshToolsButton     = $window.FindName("RefreshToolsButton")
$OpenSelectedToolButton = $window.FindName("OpenSelectedToolButton")
$CopyDebugButton        = $window.FindName("CopyDebugButton")
...
$ToolsListBox           = $window.FindName("ToolsListBox")
$SelectedToolNameText   = $window.FindName("SelectedToolNameText")
$SelectedToolPathText   = $window.FindName("SelectedToolPathText")
...
function Set-ButtonsEnabled {
    ...
    $RefreshToolsButton.IsEnabled     = $Enabled
    $OpenSelectedToolButton.IsEnabled = $Enabled
    $CopyDebugButton.IsEnabled        = $Enabled
...
function Update-SelectedToolDetails {
    $SelectedToolNameText.Text = "No tool selected"
    $SelectedToolPathText.Text = ""

    $selected = $ToolsListBox.SelectedItem
    if ($null -eq $selected) { return }

    $name = [string]$selected
    if ($script:ToolMap.ContainsKey($name)) {
        $tool = $script:ToolMap[$name]
        $SelectedToolNameText.Text = $tool.Name
        $SelectedToolPathText.Text = $tool.FullName
    }
}
    ...
    try {
        if (Test-Path $dest) {
            ...
            foreach ($tool in $tools) {
                $display = $tool.Name
                if ($script:ToolMap.ContainsKey($display)) {
                    $display = "$($tool.Name)  •  $($tool.Directory.Name)"
                }
                $script:ToolMap[$display] = $tool
                [void]$ToolsListBox.Items.Add($display)
            }
...
function Get-InstallState {
    try {
        if (!(Test-Path $dest)) {
            return @{
                Title    = "Not installed"
                Subtitle = "No toolkit folder was found yet."
                Chip     = "Idle"
                Step     = "Waiting"
                Progress = 0
            }
        ...
        if ($count -gt 0) {
            return @{
                Title    = "Installed"
                Subtitle = "The toolkit is already present on this system."
                Chip     = "Installed"
                Step     = "Ready"
                Progress = 100
            }
        ...
        return @{
            ...
            Subtitle = "An install folder exists, but no executable tools were found."
            Chip     = "Detected"
            Step     = "Review"
            Progress = 30
        }
        ...
        return @{
            Title    = "Ready"
            Subtitle = "Everything is ready. Pick an action on the left."
            Chip     = "Idle"
            Step     = "Waiting"
            Progress = 0
        }
...
function Apply-StartupState {
    ...
    Set-UiState $state.Title $state.Subtitle $state.Chip $state.Step $state.Progress
    Refresh-ToolList
}

function Get-DebugInfoText {
    $toolCount = $ToolCountText.Text
    $selectedTool = if ($ToolsListBox.SelectedItem) { [string]$ToolsListBox.SelectedItem } else { "None" }

@"
Tesla Launcher Debug Info
------------------------
...
$RefreshToolsButton.Add_Click({
    Refresh-ToolList
    Show-AppMessage "Refreshed" "The tools list has been refreshed." "Success"
})

$OpenSelectedToolButton.Add_Click({
    try {
        $selected = $ToolsListBox.SelectedItem
        if ($null -eq $selected) {
            Show-AppMessage "Open Tool" "Please select a tool first." "Warning"
            return
        }

        $name = [string]$selected
        if (-not $script:ToolMap.ContainsKey($name)) {
            Show-AppMessage "Open Tool" "The selected tool could not be found." "Error"
            return
        }

        Start-Process $script:ToolMap[$name].FullName
    }
    catch {
        Show-AppMessage "Open Tool Failed" $_.Exception.Message "Error"
    }
})

$CopyDebugButton.Add_Click({
    try {
        [System.Windows.Clipboard]::SetText((Get-DebugInfoText))
        Show-AppMessage "Copied" "Debug info copied to clipboard." "Success"
    }
    catch {
        Show-AppMessage "Copy Failed" "The debug info could not be copied." "Error"
    }
})

$ToolsListBox.Add_SelectionChanged({
    Update-SelectedToolDetails
})

$InfoButtonTop.Add_Click({ Show-InfoOverlay })
$OverlayCloseButton.Add_Click({ Hide-InfoOverlay })
$OverlayOkButton.Add_Click({ Hide-InfoOverlay })
...
$window.Add_PreviewKeyDown({
    ...
    if ($OverlayRoot.Visibility -eq "Visible" -and $e.Key -eq "Escape") {
        Hide-InfoOverlay
        $e.Handled = $true
    }
})
