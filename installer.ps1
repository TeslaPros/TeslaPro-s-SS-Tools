...
$script:FullscreenBefore = $null
$script:IsSidebarCollapsed = $false
$script:SidebarExpandedWidth = 250
$script:SidebarCollapsedWidth = 76
$script:SuppressResponsiveSidebar = $false
...
<Window xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
    ...
    <Window.Resources>
        ...
        <SolidColorBrush x:Key="SidebarDeepBrush" Color="#10131C"/>
        ...
        <SolidColorBrush x:Key="ElevatedBrush" Color="#2A3040"/>
        ...
        <SolidColorBrush x:Key="AccentTwoBrush" Color="#8B5CF6"/>
        ...
        <SolidColorBrush x:Key="WarningBrush" Color="#F6C85F"/>
        <SolidColorBrush x:Key="FocusBrush" Color="#97D7FF"/>

        <LinearGradientBrush x:Key="AppBackgroundBrush" StartPoint="0,0" EndPoint="1,1">
            <GradientStop Color="#101116" Offset="0"/>
            <GradientStop Color="#111B2A" Offset="0.46"/>
            <GradientStop Color="#151326" Offset="1"/>
        </LinearGradientBrush>
        <LinearGradientBrush x:Key="HeroGradientBrush" StartPoint="0,0" EndPoint="1,1">
            <GradientStop Color="#263855" Offset="0"/>
            <GradientStop Color="#161B2A" Offset="0.62"/>
            <GradientStop Color="#201934" Offset="1"/>
        </LinearGradientBrush>
        <LinearGradientBrush x:Key="FeatureGradientBrush" StartPoint="0,0" EndPoint="1,1">
            <GradientStop Color="#243147" Offset="0"/>
            <GradientStop Color="#1C2230" Offset="0.62"/>
            <GradientStop Color="#151C29" Offset="1"/>
        </LinearGradientBrush>
        <LinearGradientBrush x:Key="PrimaryGradientBrush" StartPoint="0,0" EndPoint="1,1">
            <GradientStop Color="#58B7FF" Offset="0"/>
            <GradientStop Color="#30A4FF" Offset="0.48"/>
            <GradientStop Color="#8B5CF6" Offset="1"/>
        </LinearGradientBrush>

        <DropShadowEffect x:Key="SoftShadow" Color="#000000" Opacity="0.25" BlurRadius="24" ShadowDepth="8"/>
        <DropShadowEffect x:Key="SmallShadow" Color="#000000" Opacity="0.18" BlurRadius="12" ShadowDepth="3"/>
        ...
        <Style x:Key="FeatureCardButtonStyle" TargetType="{x:Type Button}" BasedOn="{StaticResource BaseButtonStyle}">
            <Setter Property="Background" Value="{DynamicResource FeatureGradientBrush}"/>
            <Setter Property="BorderBrush" Value="#3D4B66"/>
                ...
                <Setter.Value>
                    <ControlTemplate TargetType="{x:Type Button}">
                        <Border x:Name="Chrome"
                                ...
                                Padding="{TemplateBinding Padding}">
                            <Grid>
                                <Ellipse Width="150" Height="150" Fill="#1830A4FF" HorizontalAlignment="Right" VerticalAlignment="Top" Margin="0,-64,-50,0"/>
                                <Ellipse Width="90" Height="90" Fill="#158B5CF6" HorizontalAlignment="Left" VerticalAlignment="Bottom" Margin="-38,0,0,-42"/>
                                <ContentPresenter HorizontalAlignment="{TemplateBinding HorizontalContentAlignment}"
                                                  VerticalAlignment="{TemplateBinding VerticalContentAlignment}"/>
                            </Grid>
                        </Border>
        ...
        <Style x:Key="CloseWindowButtonStyle" TargetType="{x:Type Button}" BasedOn="{StaticResource WindowButtonStyle}">
            <Setter Property="Template">
                <Setter.Value>
                    <ControlTemplate TargetType="{x:Type Button}">
                        <Border x:Name="Chrome" Background="Transparent" CornerRadius="8" Padding="{TemplateBinding Padding}">
                ...
                <Setter.Value>
                    <ControlTemplate TargetType="{x:Type CheckBox}">
                        <Grid>
                            ...
                            <Border x:Name="Track" Width="44" Height="24" CornerRadius="12" Background="#30384A" BorderBrush="{DynamicResource LineBrush}" BorderThickness="1" HorizontalAlignment="Left"/>
                            <Ellipse x:Name="Knob" Width="18" Height="18" Fill="{DynamicResource MutedBrush}" HorizontalAlignment="Left" Margin="3,0,0,0"/>
                        ...
                        <ControlTemplate.Triggers>
                            ...
                            <Trigger Property="IsKeyboardFocused" Value="True">
                                <Setter TargetName="Track" Property="BorderBrush" Value="{DynamicResource FocusBrush}"/>
                            </Trigger>
                        </ControlTemplate.Triggers>
                    </ControlTemplate>
                </Setter.Value>
        ...
        <Style TargetType="{x:Type ProgressBar}">
            ...
            <Setter Property="Background" Value="#151A25"/>
        </Style>

        <Style TargetType="{x:Type ScrollBar}">
            <Setter Property="Width" Value="9"/>
            <Setter Property="Background" Value="Transparent"/>
            <Setter Property="Foreground" Value="#4B5770"/>
        </Style>
        ...
        <DataTemplate x:Key="ToolRowTemplate">
            <Grid>
                ...
                <Border Width="38" Height="38" CornerRadius="12" Background="#2430A4FF" Margin="0,0,10,0" VerticalAlignment="Top">
                    <TextBlock Text="T" Foreground="{DynamicResource AccentBrush}" FontWeight="Bold" HorizontalAlignment="Center" VerticalAlignment="Center"/>
                </Border>
                ...
                <StackPanel Grid.Column="2" Margin="12,0,0,0" HorizontalAlignment="Right">
                    <Border Background="#203448" CornerRadius="8" Padding="8,3">
                        <TextBlock Text="{Binding Category}" FontSize="11" Foreground="{DynamicResource AccentBrush}"/>
                    </Border>
                    <Border Background="#1E62C370" BorderBrush="#5562C370" BorderThickness="1" CornerRadius="8" Padding="8,3" Margin="0,7,0,0">
                        <TextBlock Text="{Binding Status}" FontSize="11" Foreground="{DynamicResource SuccessBrush}" HorizontalAlignment="Right"/>
                    </Border>
                </StackPanel>
            </Grid>
        </DataTemplate>
        ...
        <DataTemplate x:Key="CommandRowTemplate">
            <Grid>
                ...
                <Border Width="38" Height="38" CornerRadius="12" Background="#248B5CF6" Margin="0,0,10,0" VerticalAlignment="Top">
                    <TextBlock Text="C" Foreground="{DynamicResource AccentTwoBrush}" FontWeight="Bold" HorizontalAlignment="Center" VerticalAlignment="Center"/>
                </Border>
                <StackPanel Grid.Column="1">
                    <TextBlock Text="{Binding Name}" FontWeight="SemiBold" FontSize="15" Foreground="{DynamicResource TextBrush}"/>
                ...
                <StackPanel Grid.Column="2" Margin="12,0,0,0">
                    ...
                    <Border Background="#1E8B5CF6" BorderBrush="#558B5CF6" BorderThickness="1" CornerRadius="8" Padding="8,3" Margin="0,7,0,0">
                        <TextBlock Text="{Binding Shell}" FontSize="11" Foreground="{DynamicResource AccentTwoBrush}" HorizontalAlignment="Right"/>
                    </Border>
                </StackPanel>
            </Grid>
        </DataTemplate>
    ...
    <Grid Background="{DynamicResource AppBackgroundBrush}">
        <Grid.RowDefinitions>
            <RowDefinition x:Name="TitleBarRow" Height="50"/>
            <RowDefinition Height="*"/>
            <RowDefinition x:Name="StatusBarRow" Height="34"/>
        </Grid.RowDefinitions>

        <Border x:Name="TitleBar" Grid.Row="0" Background="#D9151A24" BorderBrush="{DynamicResource LineBrush}" BorderThickness="0,0,0,1">
            <Grid>
                <Grid.ColumnDefinitions>
                    <ColumnDefinition Width="*"/>
                    <ColumnDefinition Width="Auto"/>
                ...
                <StackPanel Orientation="Horizontal" VerticalAlignment="Center" Margin="16,0,0,0">
                    <Border Width="30" Height="30" CornerRadius="10" Background="{DynamicResource PrimaryGradientBrush}" Effect="{StaticResource SmallShadow}">
                        <TextBlock Text="T" Foreground="#07111C" FontWeight="Bold" FontSize="16" HorizontalAlignment="Center" VerticalAlignment="Center"/>
                    </Border>
                    <StackPanel Margin="10,0,0,0" VerticalAlignment="Center">
                        <TextBlock Text="TeslaPro Tools" FontSize="15" FontWeight="SemiBold"/>
                        <TextBlock x:Name="TxtTitleVersion" Text="v" FontSize="11" Foreground="{DynamicResource MutedBrush}"/>
                    </StackPanel>
                </StackPanel>
                <StackPanel Grid.Column="1" Orientation="Horizontal" VerticalAlignment="Center" Margin="0,0,8,0">
                    <Button x:Name="BtnWindowMinimize" Content="-" ToolTip="Minimize" Style="{StaticResource WindowButtonStyle}"/>
                    <Button x:Name="BtnWindowMaxRestore" Content="Max" ToolTip="Maximize or restore" Style="{StaticResource WindowButtonStyle}"/>
                    <Button x:Name="BtnWindowFullscreen" Content="Full" ToolTip="Fullscreen (F11)" Style="{StaticResource WindowButtonStyle}"/>
                    <Button x:Name="BtnWindowClose" Content="X" ToolTip="Close" Style="{StaticResource CloseWindowButtonStyle}"/>
                </StackPanel>
            </Grid>
        </Border>
        ...
        <Grid x:Name="AppBody" Grid.Row="1">
            ...
            <Border x:Name="SidebarContainer" Grid.Column="0" Background="#D9171B27" BorderBrush="{DynamicResource LineBrush}" BorderThickness="0,0,1,0">
                <Grid>
                    <Grid.RowDefinitions>
                        <RowDefinition Height="Auto"/>
                        <RowDefinition Height="Auto"/>
                    ...
                    <Grid Margin="14,16,14,12">
                        <Grid.ColumnDefinitions>
                            <ColumnDefinition Width="*"/>
                            <ColumnDefinition Width="Auto"/>
                        </Grid.ColumnDefinitions>
                        <StackPanel x:Name="SidebarBrandPanel" Orientation="Horizontal">
                            <Border Width="34" Height="34" CornerRadius="12" Background="{DynamicResource PrimaryGradientBrush}">
                                <TextBlock Text="TP" Foreground="#07111C" FontWeight="Bold" FontSize="12" HorizontalAlignment="Center" VerticalAlignment="Center"/>
                            </Border>
                            <StackPanel x:Name="SidebarBrandText" Margin="10,0,0,0" VerticalAlignment="Center">
                                <TextBlock Text="TeslaPro" FontWeight="SemiBold"/>
                                <TextBlock Text="Official launcher" Foreground="{DynamicResource MutedBrush}" FontSize="11"/>
                            </StackPanel>
                        </StackPanel>
                        <Button x:Name="BtnSidebarToggle" Grid.Column="1" Content="&lt;" ToolTip="Collapse sidebar" Style="{StaticResource WindowButtonStyle}" VerticalAlignment="Center"/>
                    </Grid>
                    <TextBlock x:Name="TxtSidebarSection" Grid.Row="1" Text="Navigation" Foreground="{DynamicResource MutedBrush}" FontSize="12" Margin="22,0,0,10"/>
                    <StackPanel Grid.Row="2">
                        <Button x:Name="BtnNavHome" ToolTip="Home" Style="{StaticResource NavButtonStyle}"/>
                        <Button x:Name="BtnNavTools" ToolTip="Tools" Style="{StaticResource NavButtonStyle}"/>
                        <Button x:Name="BtnNavCommands" ToolTip="CMD Commands" Style="{StaticResource NavButtonStyle}"/>
                        <Button x:Name="BtnNavDownloads" ToolTip="Downloads" Style="{StaticResource NavButtonStyle}"/>
                        <Button x:Name="BtnNavInfo" ToolTip="Info" Style="{StaticResource NavButtonStyle}"/>
                        <Button x:Name="BtnNavSettings" ToolTip="Settings" Style="{StaticResource NavButtonStyle}"/>
                    </StackPanel>
                    <StackPanel Grid.Row="3" Margin="12,0,12,16">
                        <Border x:Name="SidebarStatusCard" Background="{DynamicResource PanelBrush}" CornerRadius="12" Padding="12" Margin="0,0,0,10" BorderBrush="{DynamicResource LineBrush}" BorderThickness="1">
                            <StackPanel>
                                <TextBlock x:Name="TxtSidebarStatusTitle" Text="Official-source mode" Foreground="{DynamicResource AccentBrush}" FontWeight="SemiBold" FontSize="12"/>
                                <TextBlock x:Name="TxtSidebarStatusBody" Text="No repackaging. No mirrors. Direct sources only." Foreground="{DynamicResource MutedBrush}" TextWrapping="Wrap" FontSize="11" Margin="0,5,0,0"/>
                            </StackPanel>
                        </Border>
                        <Button x:Name="BtnNavExit" ToolTip="Exit" Content="Exit" Style="{StaticResource DangerButtonStyle}"/>
                    </StackPanel>
                </Grid>
            </Border>

            <Grid x:Name="PageHost" Grid.Column="1" Background="Transparent">
                <Grid x:Name="PageHome" Margin="28">
                    <Grid.RowDefinitions>
                        <RowDefinition Height="Auto"/>
                        <RowDefinition Height="*"/>
                        <RowDefinition Height="Auto"/>
                    </Grid.RowDefinitions>
                    <Border Background="{DynamicResource HeroGradientBrush}" BorderBrush="#34415A" BorderThickness="1" CornerRadius="20" Padding="24" Effect="{StaticResource SmallShadow}">
                        <Grid>
                            <Ellipse Width="260" Height="260" Fill="#1230A4FF" HorizontalAlignment="Right" VerticalAlignment="Top" Margin="0,-146,-86,0"/>
                            <Ellipse Width="180" Height="180" Fill="#168B5CF6" HorizontalAlignment="Left" VerticalAlignment="Bottom" Margin="-86,0,0,-116"/>
                            <Grid>
                                <Grid.ColumnDefinitions>
                                    <ColumnDefinition Width="*"/>
                                    <ColumnDefinition Width="Auto"/>
                                ...
                                <StackPanel>
                                    <WrapPanel>
                                        <Border Background="#2630A4FF" BorderBrush="{DynamicResource AccentBrush}" BorderThickness="1" CornerRadius="12" Padding="10,4" Margin="0,0,8,12">
                                            <TextBlock Text="Official-source launcher" Foreground="{DynamicResource AccentBrush}" FontSize="12" FontWeight="SemiBold"/>
                                        </Border>
                                        <Border Background="#2262C370" BorderBrush="{DynamicResource SuccessBrush}" BorderThickness="1" CornerRadius="12" Padding="10,4" Margin="0,0,8,12">
                                            <TextBlock Text="Ready" Foreground="{DynamicResource SuccessBrush}" FontSize="12" FontWeight="SemiBold"/>
                                        </Border>
                                    </WrapPanel>
                                    <TextBlock Text="Welcome to TeslaPro Tools" FontSize="34" FontWeight="Bold"/>
                                    <TextBlock Text="A polished Windows launcher for official tool sources, secure downloads and reusable command references." Foreground="{DynamicResource MutedBrush}" FontSize="15" TextWrapping="Wrap" MaxWidth="760" Margin="0,8,0,0"/>
                                </StackPanel>
                                <StackPanel Grid.Column="1" VerticalAlignment="Center" Margin="24,0,0,0">
                                    <TextBlock Text="Session" Foreground="{DynamicResource MutedBrush}" FontSize="12"/>
                                    <TextBlock x:Name="TxtHomeSessionState" Text="Secure mode ready" FontWeight="SemiBold" FontSize="16"/>
                                    <TextBlock x:Name="TxtHomeVersion" Text="Version" Foreground="{DynamicResource MutedBrush}" FontSize="12" Margin="0,4,0,0"/>
                                </StackPanel>
                            </Grid>
                        </Grid>
                    </Border>
                    <Grid Grid.Row="1" VerticalAlignment="Center" Margin="0,24,0,24">
                        <Grid.ColumnDefinitions>
                            <ColumnDefinition Width="*"/>
                            <ColumnDefinition Width="20"/>
                            <ColumnDefinition Width="*"/>
                        </Grid.ColumnDefinitions>
                        <Button x:Name="BtnHomeTools" Grid.Column="0" Style="{StaticResource FeatureCardButtonStyle}">
                            <Grid>
                                <Grid.RowDefinitions>
                                    <RowDefinition Height="Auto"/>
                                    <RowDefinition Height="*"/>
                                ...
                                <Border Width="52" Height="52" CornerRadius="16" Background="#2430A4FF" HorizontalAlignment="Left">
                                    <TextBlock Text="TL" FontSize="18" FontWeight="Bold" HorizontalAlignment="Center" VerticalAlignment="Center"/>
                                </Border>
                                <StackPanel Grid.Row="1" VerticalAlignment="Center">
                                    <TextBlock Text="Tools" FontSize="30" FontWeight="Bold"/>
                                    <TextBlock Text="Browse trusted sources, releases and secure downloads." Foreground="{DynamicResource MutedBrush}" FontSize="14" TextWrapping="Wrap" Margin="0,8,0,0"/>
                                </StackPanel>
                                <Grid Grid.Row="2">
                                    <TextBlock x:Name="TxtHomeToolsCardCount" Text="0 tools" Foreground="{DynamicResource AccentBrush}" FontWeight="SemiBold"/>
                                    <TextBlock Text="Open >" HorizontalAlignment="Right" Foreground="{DynamicResource TextBrush}" FontWeight="SemiBold"/>
                                </Grid>
                            </Grid>
                        </Button>
                        <Button x:Name="BtnHomeCommands" Grid.Column="2" Style="{StaticResource FeatureCardButtonStyle}">
                            <Grid>
                                <Grid.RowDefinitions>
                                    <RowDefinition Height="Auto"/>
                                    <RowDefinition Height="*"/>
                                ...
                                <Border Width="52" Height="52" CornerRadius="16" Background="#248B5CF6" HorizontalAlignment="Left">
                                    <TextBlock Text="CMD" FontSize="15" FontWeight="Bold" HorizontalAlignment="Center" VerticalAlignment="Center"/>
                                </Border>
                                <StackPanel Grid.Row="1" VerticalAlignment="Center">
                                    <TextBlock Text="CMD Commands" FontSize="30" FontWeight="Bold"/>
                                    <TextBlock Text="Copy documented Windows and PowerShell commands." Foreground="{DynamicResource MutedBrush}" FontSize="14" TextWrapping="Wrap" Margin="0,8,0,0"/>
                                </StackPanel>
                                <Grid Grid.Row="2">
                                    <TextBlock x:Name="TxtHomeCommandsCardCount" Text="0 commands" Foreground="{DynamicResource AccentBrush}" FontWeight="SemiBold"/>
                                    <TextBlock Text="Open >" HorizontalAlignment="Right" Foreground="{DynamicResource TextBrush}" FontWeight="SemiBold"/>
                                </Grid>
                            </Grid>
                        </Button>
                    ...
                    <UniformGrid Grid.Row="2" Columns="4">
                        <Border Background="{DynamicResource PanelBrush}" BorderBrush="{DynamicResource LineBrush}" BorderThickness="1" CornerRadius="14" Padding="14" Margin="0,0,10,0">
                            <StackPanel>
                                <TextBlock Text="Tools" Foreground="{DynamicResource MutedBrush}" FontSize="12"/>
                                <TextBlock x:Name="TxtHomeToolCount" Text="0" FontSize="22" FontWeight="Bold"/>
                            </StackPanel>
                        </Border>
                        <Border Background="{DynamicResource PanelBrush}" BorderBrush="{DynamicResource LineBrush}" BorderThickness="1" CornerRadius="14" Padding="14" Margin="0,0,10,0">
                            <StackPanel>
                                <TextBlock Text="Commands" Foreground="{DynamicResource MutedBrush}" FontSize="12"/>
                                <TextBlock x:Name="TxtHomeCommandCount" Text="0" FontSize="22" FontWeight="Bold"/>
                            </StackPanel>
                        </Border>
                        <Border Background="{DynamicResource PanelBrush}" BorderBrush="{DynamicResource LineBrush}" BorderThickness="1" CornerRadius="14" Padding="14" Margin="0,0,10,0">
                            <StackPanel>
                                <TextBlock Text="Downloads" Foreground="{DynamicResource MutedBrush}" FontSize="12"/>
                                <TextBlock x:Name="TxtHomeDownloadCount" Text="0 active" FontSize="22" FontWeight="Bold"/>
                            </StackPanel>
                        </Border>
                        <Border Background="{DynamicResource PanelBrush}" BorderBrush="{DynamicResource LineBrush}" BorderThickness="1" CornerRadius="14" Padding="14">
                            <StackPanel>
                                <TextBlock Text="Status" Foreground="{DynamicResource MutedBrush}" FontSize="12"/>
                                <TextBlock x:Name="TxtHomeStatus" Text="Ready" Foreground="{DynamicResource SuccessBrush}" FontSize="18" FontWeight="SemiBold"/>
                            </StackPanel>
                        </Border>
                    </UniformGrid>
                </Grid>
                ...
                <Grid x:Name="PageDownloads" Visibility="Collapsed" Margin="24">
                    ...
                    <Grid Grid.Row="1" Margin="0,18,0,0">
                        <ListBox x:Name="ListDownloads"
                                 ...
                                 VirtualizingStackPanel.IsVirtualizing="True"
                                 VirtualizingStackPanel.VirtualizationMode="Recycling"/>
                        <Border x:Name="DownloadsEmptyState" Background="{DynamicResource PanelBrush}" BorderBrush="{DynamicResource LineBrush}" BorderThickness="1" CornerRadius="18" Padding="28" VerticalAlignment="Top">
                            <StackPanel HorizontalAlignment="Center">
                                <TextBlock Text="v" FontSize="38" Foreground="{DynamicResource AccentBrush}" HorizontalAlignment="Center"/>
                                <TextBlock Text="No downloads yet" FontSize="20" FontWeight="SemiBold" HorizontalAlignment="Center" Margin="0,8,0,0"/>
                                <TextBlock Text="Start an official download from the Tools page and it will appear here." Foreground="{DynamicResource MutedBrush}" TextAlignment="Center" TextWrapping="Wrap" MaxWidth="420" Margin="0,6,0,0"/>
                            </StackPanel>
                        </Border>
                    </Grid>
                </Grid>
                ...
                <Grid x:Name="PageInfo" Visibility="Collapsed" Margin="30">
                    ...
                    <ScrollViewer Grid.Row="1" VerticalScrollBarVisibility="Auto" Margin="0,20,0,0">
                        <UniformGrid Columns="2">
                            <Border Background="{DynamicResource PanelBrush}" BorderBrush="{DynamicResource LineBrush}" BorderThickness="1" CornerRadius="16" Padding="20" Margin="0,0,12,12" Effect="{StaticResource SmallShadow}">
                                <StackPanel>
                                    <TextBlock Text="Project" Foreground="{DynamicResource AccentBrush}" FontWeight="SemiBold"/>
                                    <TextBlock Text="TeslaPro Tools is an independent launcher that points users to official websites, repositories and distribution channels of external tools." TextWrapping="Wrap" FontSize="15" LineHeight="22" Margin="0,8,0,0"/>
                                </StackPanel>
                            </Border>
                            <Border Background="{DynamicResource PanelBrush}" BorderBrush="{DynamicResource LineBrush}" BorderThickness="1" CornerRadius="16" Padding="20" Margin="0,0,0,12" Effect="{StaticResource SmallShadow}">
                                <StackPanel>
                                    <TextBlock Text="Transparency" Foreground="{DynamicResource AccentBrush}" FontWeight="SemiBold"/>
                                    <TextBlock Text="TeslaPro Tools does not host, modify, bundle or repackage external tools. Credits remain with the original creators." TextWrapping="Wrap" Foreground="{DynamicResource MutedBrush}" LineHeight="20" Margin="0,8,0,0"/>
                                </StackPanel>
                            </Border>
                            <Border Background="{DynamicResource PanelBrush}" BorderBrush="{DynamicResource LineBrush}" BorderThickness="1" CornerRadius="16" Padding="20" Margin="0,0,12,12">
                                <StackPanel>
                                    <TextBlock Text="Security posture" Foreground="{DynamicResource AccentBrush}" FontWeight="SemiBold"/>
                                    <TextBlock Text="Downloads validate HTTPS, domains, redirects, file extensions, safe paths and optional SHA-256 hashes." TextWrapping="Wrap" Foreground="{DynamicResource MutedBrush}" LineHeight="20" Margin="0,8,0,0"/>
                                </StackPanel>
                            </Border>
                            <Border Background="{DynamicResource PanelBrush}" BorderBrush="{DynamicResource LineBrush}" BorderThickness="1" CornerRadius="16" Padding="20" Margin="0,0,0,12">
                                <StackPanel>
                                    <TextBlock Text="Community" Foreground="{DynamicResource AccentBrush}" FontWeight="SemiBold"/>
                                    <TextBlock Text="Official Discord server: TeslaPro. Developed with AI assistance and reviewed for one-file WPF structure." TextWrapping="Wrap" Foreground="{DynamicResource MutedBrush}" LineHeight="20" Margin="0,8,0,0"/>
                ...
                <Grid x:Name="PageSettings" Visibility="Collapsed" Margin="30">
                    ...
                    <StackPanel>
                        ...
                        <TextBlock Text="Session-only preferences for motion, safety, layout and downloads." Foreground="{DynamicResource MutedBrush}" Margin="0,6,0,0"/>
                    </StackPanel>
                    <ScrollViewer Grid.Row="1" VerticalScrollBarVisibility="Auto" Margin="0,20,0,0">
                        <StackPanel>
                            <Border Background="{DynamicResource PanelBrush}" BorderBrush="{DynamicResource LineBrush}" BorderThickness="1" CornerRadius="16" Padding="18" Margin="0,0,0,12">
                                <StackPanel>
                                    <TextBlock Text="Interface" Foreground="{DynamicResource AccentBrush}" FontWeight="SemiBold" Margin="0,0,0,12"/>
                                    <CheckBox x:Name="ChkAnimations" Content="Enable animations" IsChecked="True" Style="{StaticResource ToggleSwitchStyle}"/>
                                    <CheckBox x:Name="ChkReducedMotion" Content="Reduced motion" Style="{StaticResource ToggleSwitchStyle}"/>
                                    <CheckBox x:Name="ChkStartFullscreen" Content="Start fullscreen in this session" Style="{StaticResource ToggleSwitchStyle}"/>
                                    <CheckBox x:Name="ChkSidebarCollapsed" Content="Use compact sidebar" Style="{StaticResource ToggleSwitchStyle}"/>
                                    <Grid Margin="0,4,0,0">
                                        <Grid.ColumnDefinitions>
                                            <ColumnDefinition Width="Auto"/>
                                        ...
                                        <TextBlock Grid.Column="4" Text="Scale" VerticalAlignment="Center" Foreground="{DynamicResource MutedBrush}"/>
                                        <ComboBox x:Name="CmbInterfaceScale" Grid.Column="6" Style="{StaticResource ComboStyle}"/>
                                    </Grid>
                                </StackPanel>
                            </Border>
                            <Border Background="{DynamicResource PanelBrush}" BorderBrush="{DynamicResource LineBrush}" BorderThickness="1" CornerRadius="16" Padding="18" Margin="0,0,0,12">
                                <StackPanel>
                                    <TextBlock Text="Safety" Foreground="{DynamicResource AccentBrush}" FontWeight="SemiBold" Margin="0,0,0,12"/>
                                    <CheckBox x:Name="ChkConfirmTools" Content="Confirm before launching downloaded tools" IsChecked="True" Style="{StaticResource ToggleSwitchStyle}"/>
                                    <CheckBox x:Name="ChkConfirmCommands" Content="Confirm before running allowed commands" IsChecked="True" Style="{StaticResource ToggleSwitchStyle}"/>
                                    <CheckBox x:Name="ChkSafeMode" Content="Safe mode: block downloads and execution" Style="{StaticResource ToggleSwitchStyle}"/>
                                    <CheckBox x:Name="ChkDownloadNotifications" Content="Show download notifications" IsChecked="True" Style="{StaticResource ToggleSwitchStyle}"/>
                                </StackPanel>
                            </Border>
                            <Border Background="{DynamicResource PanelBrush}" BorderBrush="{DynamicResource LineBrush}" BorderThickness="1" CornerRadius="16" Padding="18">
                                <StackPanel>
                                    <TextBlock Text="Downloads" Foreground="{DynamicResource AccentBrush}" FontWeight="SemiBold" Margin="0,0,0,12"/>
            ...
            <Border x:Name="NotificationBorder"
                ...
                <Border.RenderTransform>
                    <TranslateTransform x:Name="ToastTranslate" X="24"/>
                </Border.RenderTransform>
                <Grid>
                    <Grid.ColumnDefinitions>
                        <ColumnDefinition Width="Auto"/>
                    ...
                    <Border Width="28" Height="28" CornerRadius="10" Background="{DynamicResource PrimaryGradientBrush}" Margin="0,0,10,0">
                        <TextBlock Text="i" Foreground="#07111C" FontWeight="Bold" HorizontalAlignment="Center" VerticalAlignment="Center"/>
                    </Border>
                    <TextBlock x:Name="TxtNotification" Grid.Column="1" Text="Notification" TextWrapping="Wrap" VerticalAlignment="Center"/>
                    <Button x:Name="BtnToastClose" Grid.Column="2" Content="x" ToolTip="Dismiss" Style="{StaticResource WindowButtonStyle}" Width="30" Height="28" Margin="8,0,0,0"/>
                </Grid>
            </Border>
        ...
        <Border x:Name="StatusBar" Grid.Row="2" Background="#D9151A24" BorderBrush="{DynamicResource LineBrush}" BorderThickness="0,1,0,0" Padding="14,0">
            <DockPanel LastChildFill="True">
                <WrapPanel DockPanel.Dock="Left" VerticalAlignment="Center">
                    <TextBlock x:Name="TxtStatusPage" Text="Home" Foreground="{DynamicResource AccentBrush}" FontWeight="SemiBold" Margin="0,0,14,0"/>
                    <TextBlock x:Name="TxtStatusTools" Text="Tools: 0" Foreground="{DynamicResource MutedBrush}" Margin="0,0,14,0"/>
                    <TextBlock x:Name="TxtStatusCommands" Text="Commands: 0" Foreground="{DynamicResource MutedBrush}" Margin="0,0,14,0"/>
                    <TextBlock x:Name="TxtStatusDownloads" Text="Downloads: 0 active" Foreground="{DynamicResource MutedBrush}" Margin="0,0,14,0"/>
                </WrapPanel>
                <TextBlock x:Name="TxtStatusSources" Text="Official sources only" Foreground="{DynamicResource SuccessBrush}" HorizontalAlignment="Right" VerticalAlignment="Center"/>
            </DockPanel>
        </Border>
    </Grid>
</Window>
...
function Initialize-Window {
    ...
    $names = @(
        "TitleBar","TitleBarRow","StatusBarRow","AppBody","SidebarColumn","SidebarContainer","TxtTitleVersion","BtnWindowMinimize","BtnWindowMaxRestore","BtnWindowFullscreen","BtnWindowClose",
        "SidebarBrandPanel","SidebarBrandText","BtnSidebarToggle","TxtSidebarSection","SidebarStatusCard","TxtSidebarStatusTitle","TxtSidebarStatusBody",
        ...
        "BtnHomeTools","BtnHomeCommands","TxtHomeToolCount","TxtHomeCommandCount","TxtHomeStatus","TxtHomeSessionState","TxtHomeVersion","TxtHomeToolsCardCount","TxtHomeCommandsCardCount","TxtHomeDownloadCount",
        ...
        "BtnOpenDownloadFolder","BtnDownloadsBackHome","ListDownloads","DownloadsEmptyState",
        "TxtInfoVersion","BtnInfoDiscord","BtnInfoWebsite",
        "ChkAnimations","ChkReducedMotion","ChkStartFullscreen","ChkSidebarCollapsed","ChkConfirmTools","ChkConfirmCommands","ChkSafeMode","ChkDownloadNotifications","CmbTheme","CmbInterfaceScale","TxtDownloadFolder","BtnChooseDownloadFolder","BtnSettingsOpenDownloadFolder","BtnCleanupPartFiles","BtnSettingsBackHome",
        "NotificationBorder","ToastTranslate","TxtNotification","BtnToastClose","WelcomeOverlay","StatusBar","TxtStatusPage","TxtStatusTools","TxtStatusCommands","TxtStatusDownloads","TxtStatusSources"
    )
...
function New-Brush {
    param([string]$Color)
    $converted = [Windows.Media.ColorConverter]::ConvertFromString($Color)
    New-Object Windows.Media.SolidColorBrush -ArgumentList $converted
}

function Set-ResourceBrush {
    param([string]$Key, [string]$Color)
    $converted = [Windows.Media.ColorConverter]::ConvertFromString($Color)
    $existing = $script:Window.Resources[$Key]
    if ($existing -is [Windows.Media.SolidColorBrush] -and -not $existing.IsFrozen) {
        $existing.Color = $converted
    } else {
        $replacement = (New-Brush -Color $Color)
        if ($script:Window.Resources.Contains($Key)) { $script:Window.Resources.Remove($Key) }
        $script:Window.Resources.Add($Key, $replacement)
    }
}
...
#region Window state
function Update-WindowButtons {
    if ($null -eq $script:Window) { return }
    $script:BtnWindowMaxRestore.Content = if ($script:Window.WindowState -eq [Windows.WindowState]::Maximized) { "Restore" } else { "Max" }
    $script:BtnWindowFullscreen.Content = if ($script:IsFullscreen) { "Exit full" } else { "Full" }
}

function Toggle-MaxRestore {
    ...
    Update-WindowButtons
}

function Enter-Fullscreen {
    if ($script:IsFullscreen) { return }
    $helper = New-Object Windows.Interop.WindowInteropHelper -ArgumentList $script:Window
    $screen = [System.Windows.Forms.Screen]::FromHandle($helper.Handle)
    $script:FullscreenBefore = [PSCustomObject]@{
        ...
        ResizeMode  = $script:Window.ResizeMode
        TitleHeight = $script:TitleBarRow.Height
        StatusHeight = $script:StatusBarRow.Height
    }
    $script:IsFullscreen = $true
    $script:Window.WindowState = [Windows.WindowState]::Normal
    $script:Window.ResizeMode = [Windows.ResizeMode]::NoResize
    $script:Window.Left = $screen.Bounds.Left
    $script:Window.Top = $screen.Bounds.Top
    $script:Window.Width = $screen.Bounds.Width
    $script:Window.Height = $screen.Bounds.Height
    $script:TitleBarRow.Height = [Windows.GridLength]::new(0)
    $script:StatusBarRow.Height = [Windows.GridLength]::new(30)
    Update-WindowButtons
    Show-Notification "Fullscreen enabled. Press Escape or F11 to leave."
}

function Exit-Fullscreen {
    if (-not $script:IsFullscreen) { return }
    $before = $script:FullscreenBefore
    $script:IsFullscreen = $false
    $script:Window.ResizeMode = $before.ResizeMode
    $script:TitleBarRow.Height = $before.TitleHeight
    $script:StatusBarRow.Height = $before.StatusHeight
    $script:Window.WindowState = [Windows.WindowState]::Normal
    $script:Window.Left = $before.Left
    $script:Window.Top = $before.Top
    $script:Window.Width = $before.Width
    $script:Window.Height = $before.Height
    if ($before.WindowState -eq [Windows.WindowState]::Maximized) {
        $script:Window.WindowState = [Windows.WindowState]::Maximized
    }
    Update-WindowButtons
    Show-Notification "Fullscreen disabled."
}
...
function New-NavContent {
    param([string]$Icon, [string]$Label, [bool]$Collapsed)
    if ($Collapsed) {
    ...
    $iconBlock.Text = $Icon
    $iconBlock.Width = 24
    $iconBlock.FontSize = 15
    $iconBlock.VerticalAlignment = [Windows.VerticalAlignment]::Center
    $labelBlock = New-Object Windows.Controls.TextBlock
    $labelBlock.Text = $Label
    $labelBlock.Margin = [Windows.Thickness]::new(8,0,0,0)
    $labelBlock.VerticalAlignment = [Windows.VerticalAlignment]::Center
    [void]$panel.Children.Add($iconBlock)
    [void]$panel.Children.Add($labelBlock)
    return $panel
}

function Set-NavButtonContent {
    $collapsed = $script:IsSidebarCollapsed
    $items = @(
        @{ Button = $script:BtnNavHome;      Icon = "H"; Label = "Home" },
        @{ Button = $script:BtnNavTools;     Icon = "T"; Label = "Tools" },
        @{ Button = $script:BtnNavCommands;  Icon = "C"; Label = "CMD Commands" },
        @{ Button = $script:BtnNavDownloads; Icon = "D"; Label = "Downloads" },
        @{ Button = $script:BtnNavInfo;      Icon = "I"; Label = "Info" },
        @{ Button = $script:BtnNavSettings;  Icon = "S"; Label = "Settings" }
    )
    foreach ($item in $items) {
        $item.Button.Content = New-NavContent -Icon $item.Icon -Label $item.Label -Collapsed $collapsed
        $item.Button.HorizontalContentAlignment = if ($collapsed) { [Windows.HorizontalAlignment]::Center } else { [Windows.HorizontalAlignment]::Left }
    }
    $script:BtnNavExit.Content = if ($collapsed) { "X" } else { "Exit" }
    $script:BtnSidebarToggle.Content = if ($collapsed) { ">" } else { "<" }
    $script:BtnSidebarToggle.ToolTip = if ($collapsed) { "Expand sidebar" } else { "Collapse sidebar" }
}

function Set-SidebarCollapsed {
    param([bool]$Collapsed, [bool]$Animate = $true)
    $script:IsSidebarCollapsed = $Collapsed
    $script:Settings.SidebarCollapsed = $Collapsed
    if ($null -ne $script:ChkSidebarCollapsed) { $script:ChkSidebarCollapsed.IsChecked = $Collapsed }
    $target = if ($Collapsed) { $script:SidebarCollapsedWidth } else { $script:SidebarExpandedWidth }
    $start = $script:SidebarColumn.ActualWidth
    if ($start -le 0) { $start = if ($Collapsed) { $script:SidebarExpandedWidth } else { $script:SidebarCollapsedWidth } }

    $script:SidebarBrandText.Visibility = if ($Collapsed) { [Windows.Visibility]::Collapsed } else { [Windows.Visibility]::Visible }
    $script:TxtSidebarSection.Visibility = if ($Collapsed) { [Windows.Visibility]::Collapsed } else { [Windows.Visibility]::Visible }
    $script:SidebarStatusCard.Visibility = if ($Collapsed) { [Windows.Visibility]::Collapsed } else { [Windows.Visibility]::Visible }
    Set-NavButtonContent
    Set-ActiveNavButton -PageName $script:CurrentPage

    if (-not $Animate -or -not $script:Settings.AnimationsEnabled) {
        $script:SidebarColumn.Width = [Windows.GridLength]::new($target)
        return
    }
    ...
    $timer.Add_Tick({
        ...
        $width = $start + (($target - $start) * $eased)
        $script:SidebarColumn.Width = [Windows.GridLength]::new($width)
        if ($progress -ge 1) {
            $this.Stop()
            $script:SidebarColumn.Width = [Windows.GridLength]::new($target)
        }
...
function Toggle-Sidebar {
    $script:SuppressResponsiveSidebar = $true
    Set-SidebarCollapsed -Collapsed (-not $script:IsSidebarCollapsed) -Animate $true
}
#endregion

#region Responsive layout
function Update-ResponsiveLayout {
    if ($null -eq $script:Window -or $script:SuppressResponsiveSidebar) { return }
    if ($script:Window.ActualWidth -lt 1080 -and -not $script:IsSidebarCollapsed) {
        Set-SidebarCollapsed -Collapsed $true -Animate $true
    } elseif ($script:Window.ActualWidth -gt 1240 -and $script:IsSidebarCollapsed -and -not $script:Settings.SidebarCollapsed) {
        Set-SidebarCollapsed -Collapsed $false -Animate $true
    }
}
#endregion
...
function Start-PageTransition {
    ...
    $fade.From = 0
    $fade.To = 1
    $fade.Duration = New-Object Windows.Duration ([TimeSpan]::FromMilliseconds(180))
    $slide = New-Object Windows.Media.Animation.DoubleAnimation
    $slide.From = 18
    $slide.To = 0
    $slide.Duration = New-Object Windows.Duration ([TimeSpan]::FromMilliseconds(180))
    $slide.EasingFunction = New-Object Windows.Media.Animation.CubicEase -Property @{ EasingMode = [Windows.Media.Animation.EasingMode]::EaseOut }
...
function Show-Notification {
    ...
    Invoke-OnUi {
        ...
        if ($script:Settings.AnimationsEnabled) {
            $script:NotificationBorder.Opacity = 0
            $script:ToastTranslate.X = 24
            $fade = New-Object Windows.Media.Animation.DoubleAnimation
            $fade.From = 0
            $fade.To = 1
            $fade.Duration = New-Object Windows.Duration ([TimeSpan]::FromMilliseconds(170))
            $slide = New-Object Windows.Media.Animation.DoubleAnimation
            $slide.From = 24
            $slide.To = 0
            $slide.Duration = New-Object Windows.Duration ([TimeSpan]::FromMilliseconds(170))
            $slide.EasingFunction = New-Object Windows.Media.Animation.CubicEase -Property @{ EasingMode = [Windows.Media.Animation.EasingMode]::EaseOut }
            $script:NotificationBorder.BeginAnimation([Windows.UIElement]::OpacityProperty, $fade)
            $script:ToastTranslate.BeginAnimation([Windows.Media.TranslateTransform]::XProperty, $slide)
        } else {
            $script:NotificationBorder.Opacity = 1
            $script:ToastTranslate.X = 0
        }
...
function Hide-Notification {
    if ($null -eq $script:NotificationBorder) { return }
    if (-not $script:Settings.AnimationsEnabled) {
        $script:NotificationBorder.Visibility = [Windows.Visibility]::Collapsed
        return
    }
    $fade = New-Object Windows.Media.Animation.DoubleAnimation
    $fade.From = $script:NotificationBorder.Opacity
    $fade.To = 0
    $fade.Duration = New-Object Windows.Duration ([TimeSpan]::FromMilliseconds(130))
    $fade.Add_Completed({ $script:NotificationBorder.Visibility = [Windows.Visibility]::Collapsed })
    $script:NotificationBorder.BeginAnimation([Windows.UIElement]::OpacityProperty, $fade)
}
#endregion
...
function Update-HomeStats {
    ...
    $script:TxtHomeVersion.Text = "Version $script:AppVersion"
    $script:TxtHomeToolCount.Text = "{0}" -f $script:Tools.Count
    $script:TxtHomeCommandCount.Text = "{0}" -f $script:Commands.Count
    $script:TxtHomeToolsCardCount.Text = "{0} tools" -f $script:Tools.Count
    $script:TxtHomeCommandsCardCount.Text = "{0} commands" -f $script:Commands.Count
    $script:TxtHomeStatus.Text = "Ready - official sources only"
    $script:TxtHomeSessionState.Text = if ($script:Settings.SafeMode) { "Safe mode enabled" } else { "Secure mode ready" }
    Update-DownloadVisualState
    Update-StatusBar
}

function Get-ActiveDownloadCount {
    $active = 0
    foreach ($ctx in $script:DownloadContexts.Values) {
        if ($ctx.Status -eq "Active") { $active++ }
    }
    return $active
}

function Update-DownloadVisualState {
    if ($null -eq $script:DownloadsEmptyState) { return }
    $hasDownloads = ($script:DownloadsCollection.Count -gt 0)
    $script:DownloadsEmptyState.Visibility = if ($hasDownloads) { [Windows.Visibility]::Collapsed } else { [Windows.Visibility]::Visible }
    if ($null -ne $script:TxtHomeDownloadCount) {
        $script:TxtHomeDownloadCount.Text = "{0} active" -f (Get-ActiveDownloadCount)
    }
}

function Update-StatusBar {
    if ($null -eq $script:TxtStatusPage) { return }
    $page = if ([string]::IsNullOrWhiteSpace($script:CurrentPage)) { "Home" } else { $script:CurrentPage.Replace("Page","") }
    $active = Get-ActiveDownloadCount
    $script:TxtStatusPage.Text = $page
    $script:TxtStatusTools.Text = "Tools: {0}" -f $script:Tools.Count
    $script:TxtStatusCommands.Text = "Commands: {0}" -f $script:Commands.Count
    $script:TxtStatusDownloads.Text = "Downloads: {0} active" -f $active
    $script:TxtStatusSources.Text = if ($script:Settings.SafeMode) { "Safe mode" } else { "Official sources only" }
}
#endregion
...
function Apply-Theme {
    ...
    if ($Theme -eq "Light") {
        ...
        Set-ResourceBrush "SidebarDeepBrush" "#DDE5F0"
        Set-ResourceBrush "ContentBrush" "#F4F6FA"
        Set-ResourceBrush "PanelBrush" "#FFFFFF"
        Set-ResourceBrush "CardBrush" "#F6F8FC"
        Set-ResourceBrush "ElevatedBrush" "#FFFFFF"
        ...
        Set-ResourceBrush "SidebarDeepBrush" "#10131C"
        Set-ResourceBrush "ContentBrush" "#121823"
        Set-ResourceBrush "PanelBrush" "#1D202B"
        Set-ResourceBrush "CardBrush" "#252936"
        Set-ResourceBrush "ElevatedBrush" "#2A3040"
...
function Apply-InterfaceScale {
    ...
    $script:PageHost.LayoutTransform = $scaleTransform
}

function Update-SettingsFromUi {
    $script:Settings.ReducedMotion = [bool]$script:ChkReducedMotion.IsChecked
    $script:Settings.AnimationsEnabled = ([bool]$script:ChkAnimations.IsChecked -and -not $script:Settings.ReducedMotion)
    ...
    $script:Settings.StartFullscreen = [bool]$script:ChkStartFullscreen.IsChecked
    $script:Settings.SidebarCollapsed = [bool]$script:ChkSidebarCollapsed.IsChecked
    $script:Settings.InterfaceScale = [string]$script:CmbInterfaceScale.SelectedItem
    Apply-Theme -Theme $script:Settings.Theme
    Apply-InterfaceScale -Scale $script:Settings.InterfaceScale
    Set-SidebarCollapsed -Collapsed $script:Settings.SidebarCollapsed -Animate $true
    Update-HomeStats
...
function Wire-Events {
    ...
    $script:BtnWindowMaxRestore.Add_Click({ Toggle-MaxRestore })
    $script:BtnWindowFullscreen.Add_Click({ Toggle-Fullscreen })
    $script:BtnWindowClose.Add_Click({ $script:Window.Close() })
    $script:BtnSidebarToggle.Add_Click({ Toggle-Sidebar })
    $script:BtnToastClose.Add_Click({ Hide-Notification })

    $script:Window.Add_PreviewKeyDown({
        param($sender, $e)
        if ($e.Key -eq [Windows.Input.Key]::F11) {
            Toggle-Fullscreen
            $e.Handled = $true
        } elseif ($e.Key -eq [Windows.Input.Key]::Escape -and $script:IsFullscreen) {
            Exit-Fullscreen
            $e.Handled = $true
        }
    })
    $script:Window.Add_SizeChanged({ Update-ResponsiveLayout; Update-StatusBar })
    $script:Window.Add_StateChanged({ Update-WindowButtons })
    ...
    foreach ($checkbox in @($script:ChkAnimations,$script:ChkReducedMotion,$script:ChkStartFullscreen,$script:ChkSidebarCollapsed,$script:ChkConfirmTools,$script:ChkConfirmCommands,$script:ChkSafeMode,$script:ChkDownloadNotifications)) {
        $checkbox.Add_Click({ Update-SettingsFromUi })
    }
    $script:CmbTheme.Add_SelectionChanged({ Update-SettingsFromUi })
    $script:CmbInterfaceScale.Add_SelectionChanged({ Update-SettingsFromUi })
    $script:DownloadsCollection.Add_CollectionChanged({ Update-DownloadVisualState; Update-StatusBar })
...
function Initialize-Application {
    ...
    $script:CmbInterfaceScale.ItemsSource = @("100%","110%","125%")
    $script:CmbInterfaceScale.SelectedItem = $script:Settings.InterfaceScale
    $script:ChkAnimations.IsChecked = $script:Settings.AnimationsEnabled
    $script:ChkReducedMotion.IsChecked = $script:Settings.ReducedMotion
    $script:ChkStartFullscreen.IsChecked = $script:Settings.StartFullscreen
    $script:ChkSidebarCollapsed.IsChecked = $script:Settings.SidebarCollapsed
    $script:ChkConfirmTools.IsChecked = $script:Settings.ConfirmToolLaunch
    $script:ChkConfirmCommands.IsChecked = $script:Settings.ConfirmCommandRun
    $script:ChkSafeMode.IsChecked = $script:Settings.SafeMode
    $script:ChkDownloadNotifications.IsChecked = $script:Settings.DownloadNotifications
    $script:TxtDownloadFolder.Text = $script:Settings.DownloadRoot
    Initialize-ToolBinding
    Initialize-CommandBinding
    $script:ListDownloads.ItemsSource = $script:DownloadsCollection
    Set-NavButtonContent
    Set-SidebarCollapsed -Collapsed $script:Settings.SidebarCollapsed -Animate $false
    Apply-InterfaceScale -Scale $script:Settings.InterfaceScale
    Update-HomeStats
    Wire-Events
    ...
    if ($script:Settings.StartFullscreen) {
        $startupTimer = New-Object Windows.Threading.DispatcherTimer
        $startupTimer.Interval = [TimeSpan]::FromMilliseconds(850)
        $startupTimer.Add_Tick({ $this.Stop(); Enter-Fullscreen })
        $script:Timers += $startupTimer
        $startupTimer.Start()
    }
}
...
function Invoke-SelfTest {
    ...
    $requiredControls = @(
        "BtnHomeTools","BtnHomeCommands","ListTools","ListCommands","ListDownloads","BtnToolPrimaryAction","BtnCommandCopy","BtnOpenDownloadFolder",
        "BtnWindowMaxRestore","BtnWindowFullscreen","BtnSidebarToggle","SidebarColumn","StatusBar","TxtStatusPage","DownloadsEmptyState","BtnToastClose",
        "ChkReducedMotion","ChkStartFullscreen","ChkSidebarCollapsed","CmbInterfaceScale"
    )
    ...
    Set-SidebarCollapsed -Collapsed $true -Animate $false
    if (-not $script:IsSidebarCollapsed -or [int]$script:SidebarColumn.Width.Value -ne $script:SidebarCollapsedWidth) {
        throw "Sidebar collapse failed."
    }
    Set-SidebarCollapsed -Collapsed $false -Animate $false
    if ($script:IsSidebarCollapsed -or [int]$script:SidebarColumn.Width.Value -ne $script:SidebarExpandedWidth) {
        throw "Sidebar expand failed."
    }

    Enter-Fullscreen
    if (-not $script:IsFullscreen -or $script:TitleBarRow.Height.Value -ne 0) { throw "Fullscreen enter failed." }
    Exit-Fullscreen
    if ($script:IsFullscreen -or $script:TitleBarRow.Height.Value -eq 0) { throw "Fullscreen exit failed." }

    Show-Notification "Self-test toast"
    if ($script:NotificationBorder.Visibility -ne [Windows.Visibility]::Visible) { throw "Toast did not show." }
    Hide-Notification

    $script:ChkAnimations.IsChecked = $false
    $script:ChkReducedMotion.IsChecked = $false
    Update-SettingsFromUi
    if ($script:Settings.AnimationsEnabled) { throw "Animations toggle off failed." }
    $script:ChkAnimations.IsChecked = $true
    $script:CmbInterfaceScale.SelectedItem = "110%"
    Update-SettingsFromUi
    if ($script:Settings.InterfaceScale -ne "110%") { throw "Interface scale setting failed." }
    $script:CmbInterfaceScale.SelectedItem = "100%"
    Update-SettingsFromUi

    Update-DownloadVisualState
    if ($script:DownloadsCollection.Count -eq 0 -and $script:DownloadsEmptyState.Visibility -ne [Windows.Visibility]::Visible) {
        throw "Downloads empty state failed."
    }
    ...
    "SELFTEST OK: XAML loaded, controls mapped, fullscreen/sidebar/toast/settings exercised, filtering/sorting initialized, 140-item stress view passed."
}
